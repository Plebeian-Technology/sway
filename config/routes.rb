...
Rails.application.routes.draw do
    ...
    get "invite/:user_id/:invite_uuid", action: :show, controller: :invites, as: "invite"
    get "invites/:user_id/:invite_uuid", action: :show, controller: :invites, as: "invites"
    ...
    resources :user_organization_memberships, only: %i[index show create update destroy]
    ...
    namespace :notifications do
        ...
        resources :push_notification_subscriptions, only: %i[create] do
            collection { post "destroy", to: "push_notification_subscriptions#destroy" }
        end

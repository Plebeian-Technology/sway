...
Doorkeeper.configure do
  ...
  # https://doorkeeper.gitbook.io/guides/ruby-on-rails/configuration#resource-owner-authentication
  resource_owner_authenticator do
    # raise "Please configure doorkeeper resource_owner_authenticator block located in #{__FILE__}"
    # The block above runs in the context of your application so you have access to your models, session and routes helpers.
    # However, it is not run in the context of the ApplicationController which means that it doesn't have access to the methods defined over there.
    ...
    if u.nil?
      ...
      if u.has_user_legislators?
        ...
        redirect_to sway_registration_index_url
      end
    else
      u
    end
  ...
  # https://doorkeeper.gitbook.io/guides/ruby-on-rails/configuration#application-management-authentication

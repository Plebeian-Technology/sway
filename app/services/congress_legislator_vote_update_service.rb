...
class CongressLegislatorVoteUpdateService
  ...
  def senate
    ...
    Scraper::Congress::Senate::LegislatorVotes
      .new(CONGRESS, @bill.vote.senate_roll_call_vote_number)
      .process
  ...
  def house
    ...
    Scraper::Congress::House::LegislatorVotes
      .new(@bill.external_id, @bill.vote.house_roll_call_vote_number)
      .process
    ...
    legislators =
      @legislators.select do |l|
        l.first_name == vote.first_name.strip &&
          ...
          [
            vote.party,
            Legislator.to_party_name_from_char(vote.party.strip),

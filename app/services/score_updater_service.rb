 ...
 BillScoreDistrict.find_or_create_by!(district:, bill_score:).update_score(@user_vote) end
    ...
    def update_legislator_district_score
        user
            ...
            .map { |l| LegislatorDistrictScore.find_or_create_by!(legislator: l).update_score(@user_vote) }
    end
    ...
    def update_user_legislator_scores
        user
            ...
            .map { |ul| UserLegislatorScore.find_or_create_by!(user_legislator: ul).update_score(@user_vote) }
    end

...
class OpenStatesLegislatorVoteUpdateService
    ...
    def house
        ...
        T
            .cast(scraper.new(bill, house_roll_call_vote_number, "house").process, T::Array[Scraper::OpenStates::House::Vote])
    ...
    sig do
        params(
            ...
            vote: T.any(Scraper::OpenStates::Senate::Vote, Scraper::OpenStates::House::Vote),
        ).void
    end

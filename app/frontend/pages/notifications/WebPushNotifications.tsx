...
const WebPushNotifications = () => {
    const { subscriptions } = usePage<IProps>().props;
    ...
    if (subscription?.subscribed) {
        return (
            <div className="col text-start mt-5 vh-50 gap-3 d-flex flex-column">
                <div>We'll stop sending you a push notification whenever a new Bill of the Week is released.</div>
                <div>
        ...
        return (
            <div className="col text-start mt-5 vh-50 gap-3 d-flex flex-column">
                <div>We'll send you a push notification whenever a new Bill of the Week is released.</div>
                <div>

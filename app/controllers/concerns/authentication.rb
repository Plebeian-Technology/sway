...
module Authentication
    ...
    included do
        ...
        def send_phone_verification(session, phone_)
            ...
            begin
                verification =
                    twilio_client.verify.v2.services(service_sid).verifications.create(to: "+1#{phone}", channel: "sms")
        ...
        def send_email_verification(session, email)
            ...
            begin
                verification = twilio_client.verify.v2.services(service_sid).verifications.create(to: email, channel: "email")

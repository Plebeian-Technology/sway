...
class Buckets::AssetsController < ApplicationController
  extend T::Sig
  ...
  def create
    render json: {
      ...
      url: generate_put_signed_url_v4(bucket_name: SwayGoogleCloudStorage::BUCKETS[:ASSETS], file_name:, content_type: buckets_assets_params[:mime_type])
    }, status: :ok
  end

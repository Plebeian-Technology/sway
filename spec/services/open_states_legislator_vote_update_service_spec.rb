...
RSpec.describe OpenStatesLegislatorVoteUpdateService do
  before do
    ...
    command = "sqlite3 storage/development.sqlite3 '.dump \"legislators\" \"sway_locales\" \"districts\"' | grep '^INSERT' > #{data_file_path}"
  ...
  describe "#run" do
    context "a new MARYLAND Bill is created" do
      it "creates new LegislatorVotes for both the house and senate" do
        ...
        president = Legislator.find_by(external_id: "ocd-person/86f0d40f-05f4-46a2-9c24-21ff52fdc6fe").presence || build(
          :legislator,
          address:,
          district:,
          title: "Senator",
        ...
        speaker = Legislator.find_by(external_id: "ocd-person/4bf0680f-fd5c-48a1-b6d3-73672f71048a").presence || build(
          :legislator,
          address:,
          district:,
          title: "Delegate",
        ...
        senator = Legislator.find_by(external_id: "ocd-person/b0d22b6f-68c0-4dd0-892c-7844e6830693").presence || build(
          :legislator,
          address:,
          district:,
          title: "Senator",
        ...
        delegate = Legislator.find_by(external_id: "ocd-person/0bdef1bb-ea31-4a27-937c-eb680ae67343").presence || build(:legislator,
          address:,
          district:,
          first_name: "Mary",

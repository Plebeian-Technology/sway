...
shared_context "SessionDouble" do
    ...
    before do
        ...
        allow_any_instance_of(ActionDispatch::Cookies::CookieJar).to receive(:permanent).and_return(cookies_hash)
        allow_any_instance_of(ActionDispatch::Cookies::CookieJar).to receive(:encrypted).and_return(cookies_hash)
        allow_any_instance_of(ActionDispatch::Cookies::CookieJar).to receive(:signed).and_return(cookies_hash)
    end
end

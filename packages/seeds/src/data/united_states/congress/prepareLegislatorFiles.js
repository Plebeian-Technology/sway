...
var reducer = function (sum, l) {
    var item = {
        street: l.office,
        city: constants_1.STATE_CODES_NAMES[l.state].toLowerCase().replace(" ", "_"),
        region: "congress",
        regionCode: "",
        zip: "",
...
exports["default"] = (function () {
    return Promise.all([get(house), get(senate)])
        ...
        Object.keys(senators).forEach(function (state, index) {
            ...
            var stateName = constants_1.STATE_CODES_NAMES[state].toLowerCase().replace(" ", "_");
            ...
            fs.mkdir(path, { recursive: true }, function (err) {
                ...
                fs.writeFile(path + "/../index.ts", 'export * from "./legislators"', function (fileWriteError) {
                    if (fileWriteError)

                ...
                },
                {
                    ...
                    positions: {
                        "21-0001v0": {
                            support: false,
                            billFirestoreId: "21-0001v0",
                            summary: "The FOP joins the Baltimore Police Department (BPD) in opposing the bill in its current form and we make this unfavorable recommendation based on the experience of sworn personnel who have used this technology, as recently as a couple weeks ago, in assisting criminal investigations insolving the robberies, shootings and homicides that plague our town.NEWLINEAn outright ban on certain face surveillance technology, and limiting the BPD's ability to contract with various vendors, would remove a valuable tool needed to fight violent crime. We instead ask the City Council to consider urging the BPD to establish a standard operating procedure (SOP) that would establish controls, training, and tracking of the use of said technology.ENDINGhttps://baltimore.legistar.com/View.ashx?M=F&ID=9201930&GUID=2C3C1699-3580-4DCA-A64D-C9BE0F7F8972",
                        }
                    },
                },
                {

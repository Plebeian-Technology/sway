...
class Organization
  ...
  module CommonRelationMethods
    ...
    sig { params(args: T.untyped).returns(T::Array[::Organization]) }
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Organization` class because it declared `has_many :bills, through: :organization_bill_positions`.
    ...
    # This method is created by ActiveRecord on the `Organization` class because it declared `has_many :organization_bill_positions`.

...
class Doorkeeper::AccessGrant
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        block: T.proc.params(object: ::Doorkeeper::AccessGrant).void
      ).returns(Integer)
    end
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Doorkeeper::AccessGrant])
    end
    sig do
      params(
        args: NilClass,
        block: T.proc.params(object: ::Doorkeeper::AccessGrant).void
      ).returns(T.nilable(::Doorkeeper::AccessGrant))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[::Doorkeeper::AccessGrant])
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Doorkeeper::AccessGrant]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Doorkeeper::AccessGrant]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Doorkeeper::AccessGrant)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Doorkeeper::AccessGrant) }
    def find_signed!(signed_id, purpose: nil); end
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Doorkeeper::AccessGrant).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig do
      params(
        blk: T.proc.params(record: ::Doorkeeper::AccessGrant).returns(BasicObject)
      ).returns(T::Array[::Doorkeeper::AccessGrant])
    end

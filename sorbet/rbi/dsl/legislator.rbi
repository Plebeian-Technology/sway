...
class Legislator
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        records: T.any(::Legislator, Integer, String, T::Enumerable[T.any(::Legislator, Integer, String, T::Enumerable[::Legislator])])
      ).returns(Integer)
    end
    ...
    sig { params(args: T.untyped).returns(T::Array[::Legislator]) }

...
class Puma::Cluster < ::Puma::Runner
  ...
  # source://puma//lib/puma/cluster.rb#625
  def idle_timed_out_worker_pids; end

  # source://puma//lib/puma/cluster.rb#629
  ...
  # @version 5.0.0
  #
  # source://puma//lib/puma/cluster.rb#611
...
class Puma::Configuration
  ...
  #
  # source://puma//lib/puma/configuration.rb#178
  ...
  #
  # source://puma//lib/puma/configuration.rb#201
  def options; end
  ...
  # source://puma//lib/puma/configuration.rb#230
...
class Puma::DSL
  ...
  # @note Cluster mode only.
  #
  # source://puma//lib/puma/dsl.rb#736
  ...
  # @version 5.0.0
  #
  # source://puma//lib/puma/dsl.rb#870
  ...
  #   end
  #
  # source://puma//lib/puma/dsl.rb#944
  ...
  # @note Cluster mode only.
  #
  # source://puma//lib/puma/dsl.rb#752
  ...
  #
  # source://puma//lib/puma/dsl.rb#973
  ...
  #
  # source://puma//lib/puma/dsl.rb#1343
  ...
  #
  # source://puma//lib/puma/dsl.rb#1059
  ...
  # @note Cluster mode only.
  #
  # source://puma//lib/puma/dsl.rb#1297
  ...
  #
  # source://puma//lib/puma/dsl.rb#1391
  ...
  #
  # source://puma//lib/puma/dsl.rb#1303
  ...
  #   max_keep_alive 20
  #
  # source://puma//lib/puma/dsl.rb#1317
  ...
  #   end
  #
  # source://puma//lib/puma/dsl.rb#834
  ...
  # @version 5.0.0
  #
  # source://puma//lib/puma/dsl.rb#876
  ...
  #   end
  #
  # source://puma//lib/puma/dsl.rb#848
  ...
  #   end
  #
  # source://puma//lib/puma/dsl.rb#950
  ...
  #   end
  #
  # source://puma//lib/puma/dsl.rb#922
  ...
  # @note Cluster mode only.
  #
  # source://puma//lib/puma/dsl.rb#758
  ...
  # @note Cluster mode only.
  #
  # source://puma//lib/puma/dsl.rb#801
  ...
  # This can be called multiple times to add several hooks.
  #
  # source://puma//lib/puma/dsl.rb#962
  ...
  # @note Cluster mode only.
  #
  # source://puma//lib/puma/dsl.rb#987
  ...
  # @see Puma::Server
  #
  # source://puma//lib/puma/dsl.rb#1197
  ...
  #
  # source://puma//lib/puma/dsl.rb#1041
  ...
  #
  # source://puma//lib/puma/dsl.rb#1255
  ...
  #
  # source://puma//lib/puma/dsl.rb#1205
  ...
  # @note Cluster mode only.
  #
  # source://puma//lib/puma/dsl.rb#705
  ...
  #
  # source://puma//lib/puma/dsl.rb#1416
  ...
  #   tag ''
  #
  # source://puma//lib/puma/dsl.rb#1075
  def tag(string); end
  ...
  #
  # source://puma//lib/puma/dsl.rb#1221
  ...
  #
  # source://puma//lib/puma/dsl.rb#1132
  ...
  # @see Puma::Cluster::Worker#ping_timeout
  #
  # source://puma//lib/puma/dsl.rb#1110
  ...
  #
  # source://puma//lib/puma/dsl.rb#1432
  def add_pem_values_to_options_store(opts); end

  # @raise [ArgumentError]
  #
  # source://puma//lib/puma/dsl.rb#1448
...
class Puma::Launcher
  ...
  #
  # source://puma//lib/puma/launcher.rb#112
  def binder; end

  # source://puma//lib/puma/launcher.rb#224
  ...
  # @version 5.0.0
  #
  # source://puma//lib/puma/launcher.rb#210
  def connected_ports; end

  # Delete the configured pidfile
  #
  # source://puma//lib/puma/launcher.rb#140
  ...
  #
  # source://puma//lib/puma/launcher.rb#146
  def halt; end
  ...
  #
  # source://puma//lib/puma/launcher.rb#180
  def refork; end
  ...
  # @version 5.0.0
  #
  # source://puma//lib/puma/launcher.rb#235
  ...
  # @return [Boolean]
  #
  # source://puma//lib/puma/launcher.rb#336
  def clustered?; end

  # source://puma//lib/puma/launcher.rb#273
  ...
  # source://puma//lib/puma/launcher.rb#260
  ...
  # source://puma//lib/puma/launcher.rb#248
  def get_env; end

  # source://puma//lib/puma/launcher.rb#332
  def log(str); end

  # source://puma//lib/puma/launcher.rb#487
  def log_config; end

  # source://puma//lib/puma/launcher.rb#370
  def prune_bundler!; end

  # @return [Boolean]
  #
  # source://puma//lib/puma/launcher.rb#366
  def prune_bundler?; end

  # source://puma//lib/puma/launcher.rb#328
  def reload_worker_directory; end
  ...
  # source://puma//lib/puma/launcher.rb#420
  def setup_signals; end
...
class Puma::Server
  ...
  # @return [Server] a new instance of Server
  #
  # source://puma//lib/puma/server.rb#79
  def initialize(app, events = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://puma//lib/puma/server.rb#706
  def add_ssl_listener(host, port, ctx, optimize_for_latency = T.unsafe(nil), backlog = T.unsafe(nil)); end
  ...
  #
  # source://puma//lib/puma/server.rb#58
  def app; end
  ...
  # source://puma//lib/puma/server.rb#227
  def backlog; end

  # source://puma//lib/puma/server.rb#658
  ...
  # source://puma//lib/puma/server.rb#249
  def busy_threads; end

  # Handle various error types thrown by Client I/O operations.
  #
  # source://puma//lib/puma/server.rb#553
  def client_error(e, client, requests = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://puma//lib/puma/server.rb#221
  def closed_socket?(socket); end

  # source://puma//lib/puma/server.rb#716
  def connected_ports; end
  ...
  # source://puma//lib/puma/server.rb#332
  ...
  #
  # source://puma//lib/puma/server.rb#575
  ...
  #
  # source://puma//lib/puma/server.rb#244
  ...
  #
  # source://puma//lib/puma/server.rb#474
  ...
  # source://puma//lib/puma/server.rb#693
  def reset_max; end
  ...
  #
  # source://puma//lib/puma/server.rb#259
  ...
  #
  # source://puma//lib/puma/server.rb#648
  ...
  #
  # source://puma//lib/puma/server.rb#544
  def with_force_shutdown(client, &block); end

  private

  # source://puma//lib/puma/server.rb#631
  def notify_safely(message); end

  # source://puma//lib/puma/server.rb#594
  def response_to_error(client, requests, err, status_code); end

  class << self
    # source://puma//lib/puma/server.rb#152
    def current; end
    ...
    # @version 5.0.0
    #
    # source://puma//lib/puma/server.rb#158
...
# @version 5.0.0
#
# source://puma//lib/puma/server.rb#669
...
class Puma::ThreadPool
  ...
  #
  # source://puma//lib/puma/thread_pool.rb#36

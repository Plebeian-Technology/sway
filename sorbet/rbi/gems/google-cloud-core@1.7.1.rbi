...
class Google::Cloud::Config < ::BasicObject
  ...
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#308
  def [](key); end
  ...
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#296
  def []=(key, value); end
  ...
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#357
  def alias?(key); end
  ...
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#385
  def aliases!; end
  ...
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#277
  ...
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#367
  def fields!; end
  ...
  # @private
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#457
  ...
  # @return [false]
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#482
  def nil?; end
  ...
  # @return [boolean]
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#346
  ...
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#376
  def subconfigs!; end
  ...
  # @return [Hash]
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#412
  def to_h!; end
  ...
  # source://google-cloud-core//lib/google/cloud/config.rb#563
  def build_enum_validator!(allowed, allow_nil); end

  # source://google-cloud-core//lib/google/cloud/config.rb#557
  def build_match_validator!(matches, allow_nil); end

  # source://google-cloud-core//lib/google/cloud/config.rb#569
  def build_proc_validator!(proc, allow_nil); end

  # source://google-cloud-core//lib/google/cloud/config.rb#523
  def resolve_key!(key); end

  # source://google-cloud-core//lib/google/cloud/config.rb#539
  ...
  # @return [Boolean]
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#471
  def respond_to_missing?(name, include_private); end

  # source://google-cloud-core//lib/google/cloud/config.rb#529
  def validate_new_key!(key); end

  # source://google-cloud-core//lib/google/cloud/config.rb#573
  def validate_value!(key, validator, value); end

  # source://google-cloud-core//lib/google/cloud/config.rb#589
  def warn!(msg); end
  ...
  class << self
    ...
    # @private
    #
    # source://google-cloud-core//lib/google/cloud/config.rb#429
    ...
    # @private
    #
    # source://google-cloud-core//lib/google/cloud/config.rb#449
...
# @private
#
# source://google-cloud-core//lib/google/cloud/config.rb#600
class Google::Cloud::Config::DeferredValue
  # @return [DeferredValue] a new instance of DeferredValue
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#601
  def initialize(&block); end

  # source://google-cloud-core//lib/google/cloud/config.rb#605
  def call; end
end

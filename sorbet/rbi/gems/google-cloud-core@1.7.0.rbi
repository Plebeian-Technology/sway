...
class Google::Cloud::Config < ::BasicObject
  ...
  # source://google-cloud-core//lib/google/cloud/config.rb#553
  def build_enum_validator!(allowed, allow_nil); end

  # source://google-cloud-core//lib/google/cloud/config.rb#547
  def build_match_validator!(matches, allow_nil); end

  # source://google-cloud-core//lib/google/cloud/config.rb#559
  def build_proc_validator!(proc, allow_nil); end

  # source://google-cloud-core//lib/google/cloud/config.rb#513
  ...
  # source://google-cloud-core//lib/google/cloud/config.rb#519
  ...
  # source://google-cloud-core//lib/google/cloud/config.rb#579
  def warn!(msg); end
...
# @private
#
# source://google-cloud-core//lib/google/cloud/config.rb#590
class Google::Cloud::Config::DeferredValue
  # @return [DeferredValue] a new instance of DeferredValue
  #
  # source://google-cloud-core//lib/google/cloud/config.rb#591

...
class AFM::Font
  ...
  #
  # source://afm//lib/afm.rb#95
  def metrics_for(char); end

  class << self
    # alias for new()
    #
    # source://afm//lib/afm.rb#80
    def from_file(file); end
  end
end

# source://afm//lib/afm.rb#2

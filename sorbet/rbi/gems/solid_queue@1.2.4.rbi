...
class SolidQueue::Cli < ::Thor
  # source://solid_queue//lib/solid_queue/cli.rb#26
  def start; end

  class << self
    # @return [Boolean]
    #
    # source://solid_queue//lib/solid_queue/cli.rb#19
...
class SolidQueue::Configuration
  ...
  # source://solid_queue//lib/solid_queue/configuration.rb#162
  ...
  # source://solid_queue//lib/solid_queue/configuration.rb#196
  def estimated_number_of_threads; end

  # source://solid_queue//lib/solid_queue/configuration.rb#95
  def invalid_tasks; end

  # source://solid_queue//lib/solid_queue/configuration.rb#174
  def load_config_from(file_or_hash); end

  # source://solid_queue//lib/solid_queue/configuration.rb#187
...
class SolidQueue::Dispatcher < ::SolidQueue::Processes::Poller
  ...
  class << self
    ...
    # source://solid_queue//lib/solid_queue/dispatcher.rb#8
    def __class_attr___callbacks; end
...
class SolidQueue::Supervisor < ::SolidQueue::Processes::Base
  ...
  # @return [Boolean]
  #
  # source://solid_queue//lib/solid_queue/supervisor.rb#187

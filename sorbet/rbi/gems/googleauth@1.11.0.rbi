...
# source://googleauth//lib/googleauth/base_client.rb#15
module Google; end

# Module Auth provides classes that provide Google-specific authorization
# used to access Google APIs.
#
# source://googleauth//lib/googleauth/base_client.rb#18
module Google::Auth
  private
...
#
# source://googleauth//lib/googleauth/base_client.rb#24
module Google::Auth::BaseClient
  # Returns a clone of a_hash updated with the authentication token
  #
  # source://googleauth//lib/googleauth/base_client.rb#36
  def apply(a_hash, opts = T.unsafe(nil)); end

  # Updates a_hash updated with the authentication token
  #
  # source://googleauth//lib/googleauth/base_client.rb#28
  def apply!(a_hash, opts = T.unsafe(nil)); end

  # @raise [NotImplementedError]
  # @return [Boolean]
  #
  # source://googleauth//lib/googleauth/base_client.rb#65
  ...
  # @return [Boolean]
  #
  # source://googleauth//lib/googleauth/base_client.rb#43
  def needs_access_token?; end

  # source://googleauth//lib/googleauth/base_client.rb#58
  def notify_refresh_listeners; end

  # source://googleauth//lib/googleauth/base_client.rb#53
  def on_refresh(&block); end

  # Returns a reference to the #apply method, suitable for passing as
  # a closure
  #
  # source://googleauth//lib/googleauth/base_client.rb#49
  ...
  # @raise [NotImplementedError]
  #
  # source://googleauth//lib/googleauth/base_client.rb#75
  def fetch_access_token!; end

  # @raise [NotImplementedError]
  #
  # source://googleauth//lib/googleauth/base_client.rb#71
  def token_type; end
end

# source://googleauth//lib/googleauth/base_client.rb#25
...
class Google::Auth::Credentials
  ...
  #
  # source://googleauth//lib/googleauth/credentials.rb#357
  ...
  #
  # source://googleauth//lib/googleauth/credentials.rb#488
  def init_client(hash, options = T.unsafe(nil)); end

  # returns a new Hash with string keys instead of symbol keys.
  #
  # source://googleauth//lib/googleauth/credentials.rb#496
  def stringify_hash_keys(hash); end

  # returns a new Hash with symbol keys instead of string keys.
  #
  # source://googleauth//lib/googleauth/credentials.rb#501
  def symbolize_hash_keys(hash); end

  # source://googleauth//lib/googleauth/credentials.rb#505
  ...
  # source://googleauth//lib/googleauth/credentials.rb#528
  def update_from_hash(hash, options); end

  # source://googleauth//lib/googleauth/credentials.rb#522
  def update_from_signet(client); end

  # Verify that the keyfile argument is a file.
  #
  # source://googleauth//lib/googleauth/credentials.rb#482
  def verify_keyfile_exists!(keyfile); end

  # Verify that the keyfile argument is provided.
  #
  # source://googleauth//lib/googleauth/credentials.rb#476
  ...
  class << self
    ...
    # @return [Credentials]
    #
    # source://googleauth//lib/googleauth/credentials.rb#398
...
module Google::Auth::ExternalAccount::BaseCredentials
  ...
  # source://googleauth//lib/googleauth/external_account/base_credentials.rb#143
...
class Google::Auth::GCECredentials < ::Signet::OAuth2::Client
  ...
  # fetched.
  #
  # source://googleauth//lib/googleauth/compute_engine.rb#93
  def fetch_access_token(_options = T.unsafe(nil)); end

  private

  # source://googleauth//lib/googleauth/compute_engine.rb#123
...
class Google::Auth::ServiceAccountCredentials < ::Signet::OAuth2::Client
  ...
  #
  # source://googleauth//lib/googleauth/service_account.rb#92
  def initialize(options = T.unsafe(nil)); end

  # Extends the base class to use a transient
  # ServiceAccountJwtHeaderCredentials for certain cases.
  #
  # source://googleauth//lib/googleauth/service_account.rb#101
  def apply!(a_hash, opts = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://googleauth//lib/googleauth/service_account.rb#110
  def needs_access_token?; end
  ...
  # source://googleauth//lib/googleauth/service_account.rb#116
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://googleauth//lib/googleauth/service_account.rb#53
    def make_creds(options = T.unsafe(nil)); end
...
class Google::Auth::ServiceAccountJwtHeaderCredentials
  ...
  #
  # source://googleauth//lib/googleauth/service_account.rb#163
  def initialize(options = T.unsafe(nil)); end
  ...
  #
  # source://googleauth//lib/googleauth/service_account.rb#185
  def apply!(a_hash, opts = T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://googleauth//lib/googleauth/service_account.rb#226
  def needs_access_token?; end

  # Creates a jwt uri token.
  #
  # source://googleauth//lib/googleauth/service_account.rb#207
  def new_jwt_token(jwt_aud_uri = T.unsafe(nil), options = T.unsafe(nil)); end

  # Returns the value of attribute project_id.
  #
  # source://googleauth//lib/googleauth/service_account.rb#147
  def project_id; end

  # Returns the value of attribute quota_project_id.
  #
  # source://googleauth//lib/googleauth/service_account.rb#148
  def quota_project_id; end
  ...
  class << self
    ...
    # @param scope [string|array|nil] the scope(s) to access
    #
    # source://googleauth//lib/googleauth/service_account.rb#155
    def make_creds(options = T.unsafe(nil)); end
  end
end
...
# source://googleauth//lib/googleauth/signet.rb#18
module Signet
  class << self
...
class Signet::OAuth2::Client
  ...
  # source://googleauth//lib/googleauth/signet.rb#37
  ...
  # source://googleauth//lib/googleauth/signet.rb#52
  def fetch_access_token!(options = T.unsafe(nil)); end
  ...
  # source://googleauth//lib/googleauth/signet.rb#74
  ...
  #
  # source://googleauth//lib/googleauth/signet.rb#44
  def token_type; end

  # Set the universe domain
  #
  # source://googleauth//lib/googleauth/signet.rb#49
  def universe_domain; end
  ...
  # source://googleauth//lib/googleauth/signet.rb#30

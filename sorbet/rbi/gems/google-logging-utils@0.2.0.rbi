...
class Google::Logging::Message
  ...
  # @private
  #
  # source://google-logging-utils//lib/google/logging/message.rb#212
  def eql?(other); end
  ...
  #   as rendered in the standard logger formatter.
  #
  # source://google-logging-utils//lib/google/logging/message.rb#131
  def inspect; end
  ...
  #   log entry in a list of entries.
  #
  # source://google-logging-utils//lib/google/logging/message.rb#124
  def to_s; end
  ...
  #   present or known.
  #
  # source://google-logging-utils//lib/google/logging/message.rb#174
  def trace_sampled?; end
...
class Google::Logging::SourceLocation
  ...
  # @private
  #
  # source://google-logging-utils//lib/google/logging/source_location.rb#88
  def eql?(other); end

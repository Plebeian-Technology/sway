...
# source://scout_apm//lib/scout_apm/background_job_integrations/good_job.rb#3
class ScoutApm::BackgroundJobIntegrations::GoodJob
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/background_job_integrations/good_job.rb#15
  def forking?; end

  # source://scout_apm//lib/scout_apm/background_job_integrations/good_job.rb#19
  def install; end

  # Returns the value of attribute logger.
  #
  # source://scout_apm//lib/scout_apm/background_job_integrations/good_job.rb#5
  def logger; end

  # source://scout_apm//lib/scout_apm/background_job_integrations/good_job.rb#7
  def name; end

  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/background_job_integrations/good_job.rb#11
  def present?; end
end

# source://scout_apm//lib/scout_apm/background_job_integrations/good_job.rb#4
...
# source://scout_apm//lib/scout_apm/background_job_integrations/solid_queue.rb#3
class ScoutApm::BackgroundJobIntegrations::SolidQueue
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/background_job_integrations/solid_queue.rb#15
  def forking?; end

  # source://scout_apm//lib/scout_apm/background_job_integrations/solid_queue.rb#19
  def install; end

  # Returns the value of attribute logger.
  #
  # source://scout_apm//lib/scout_apm/background_job_integrations/solid_queue.rb#5
  def logger; end

  # source://scout_apm//lib/scout_apm/background_job_integrations/solid_queue.rb#7
  def name; end

  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/background_job_integrations/solid_queue.rb#11
  def present?; end
end

# source://scout_apm//lib/scout_apm/background_job_integrations/solid_queue.rb#4
...
class ScoutApm::Environment
  ...
  #
  # source://scout_apm//lib/scout_apm/environment.rb#140
  def app_server; end
  ...
  #
  # source://scout_apm//lib/scout_apm/environment.rb#134
  def app_server_integration(force = T.unsafe(nil)); end

  # source://scout_apm//lib/scout_apm/environment.rb#67
  def application_name; end

  # source://scout_apm//lib/scout_apm/environment.rb#150
  def background_job_integrations; end

  # source://scout_apm//lib/scout_apm/environment.rb#73
  def database_engine; end

  # source://scout_apm//lib/scout_apm/environment.rb#51
  def env; end
  ...
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#146
  def forking?; end

  # source://scout_apm//lib/scout_apm/environment.rb#55
  def framework; end

  # source://scout_apm//lib/scout_apm/environment.rb#59
  def framework_integration; end

  # source://scout_apm//lib/scout_apm/environment.rb#106
  def framework_root; end

  # source://scout_apm//lib/scout_apm/environment.rb#125
  def git_revision; end

  # source://scout_apm//lib/scout_apm/environment.rb#121
  def hostname; end
  ...
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#159
  def interactive?; end

  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#169
  def jruby?; end

  # Returns a string representation of the OS (ex: darwin, linux)
  #
  # source://scout_apm//lib/scout_apm/environment.rb#209
  def os; end

  # source://scout_apm//lib/scout_apm/environment.rb#63
  def platform_integration; end

  # source://scout_apm//lib/scout_apm/environment.rb#81
  def processors; end

  # source://scout_apm//lib/scout_apm/environment.rb#77
  def raw_database_adapter; end

  # source://scout_apm//lib/scout_apm/environment.rb#102
  def root; end
  ...
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#165
  def rubinius?; end

  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#178
  def ruby_187?; end

  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#173
  def ruby_19?; end

  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#183
  def ruby_2?; end

  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#188
  def ruby_3?; end

  # source://scout_apm//lib/scout_apm/environment.rb#193
  def ruby_minor; end

  # source://scout_apm//lib/scout_apm/environment.rb#94
  ...
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#222
  def sinatra?; end
  ...
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#204
  ...
  # @return [Boolean]
  #
  # source://scout_apm//lib/scout_apm/environment.rb#199
...
# source://scout_apm//lib/scout_apm/environment.rb#38
ScoutApm::Environment::FRAMEWORK_INTEGRATIONS = T.let(T.unsafe(nil), Array)

# source://scout_apm//lib/scout_apm/environment.rb#45
...
#
# source://scout_apm//lib/scout_apm/instruments/action_view.rb#83
module ScoutApm::Instruments::ActionView::ActionViewCollectionRendererInstruments
  # source://scout_apm//lib/scout_apm/instruments/action_view.rb#84
  def render_collection(*args, **kwargs); end
end

# source://scout_apm//lib/scout_apm/instruments/action_view.rb#109
module ScoutApm::Instruments::ActionView::ActionViewPartialRendererInstruments
  ...
  #
  # source://scout_apm//lib/scout_apm/instruments/action_view.rb#164
  ...
  #
  # source://scout_apm//lib/scout_apm/instruments/action_view.rb#138
  def render_partial(*args, **kwargs); end

  # In Rails 6.1, render_partial was renamed to render_partial_template
  #
  # source://scout_apm//lib/scout_apm/instruments/action_view.rb#111
  def render_partial_template(*args, **kwargs); end
end

# source://scout_apm//lib/scout_apm/instruments/action_view.rb#190
module ScoutApm::Instruments::ActionView::ActionViewTemplateRendererInstruments
  ...
  #
  # source://scout_apm//lib/scout_apm/instruments/action_view.rb#193
...
class ScoutApm::LayerConverters::RequestQueueTimeConverter < ::ScoutApm::LayerConverters::ConverterBase
  ...
  #
  # source://scout_apm//lib/scout_apm/layer_converters/request_queue_time_converter.rb#51
  def locate_timestamp; end

  # Returns a timestamp in fractional seconds since epoch
  #
  # source://scout_apm//lib/scout_apm/layer_converters/request_queue_time_converter.rb#64
...
# source://scout_apm//lib/scout_apm.rb#218

...
# source://webauthn//lib/webauthn/json_serializer.rb#3
module WebAuthn
  class << self
    ...
    # source://webauthn//lib/webauthn.rb#13
    def generate_user_id; end

    # source://webauthn//lib/webauthn/encoders.rb#4
...
class WebAuthn::AttestationStatement::Base
  ...
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#120
  ...
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#168
  ...
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#131
  ...
  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#152
  def valid_signature?(authenticator_data, client_data_hash, public_key = T.unsafe(nil)); end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#164
...
class WebAuthn::AuthenticatorAssertionResponse < ::WebAuthn::AuthenticatorResponse
  ...
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#62
  def authenticator_data; end
  ...
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#83
  def type; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#74
  def valid_sign_count?(stored_sign_count); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#70
...
# source://webauthn//lib/webauthn/authenticator_attestation_response.rb#17
class WebAuthn::AuthenticatorAttestationResponse < ::WebAuthn::AuthenticatorResponse
  ...
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#41
  ...
  #
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#69
  ...
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#71
  def type; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#80
  def valid_attestation_statement?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#75
  def valid_attested_credential?; end

  class << self
    # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#20
    def from_client(response, relying_party: T.unsafe(nil)); end
  end
end
...
class WebAuthn::AuthenticatorData < ::BinData::Record
  # source://webauthn//lib/webauthn/authenticator_data.rb#94
  def aaguid; end

  # source://webauthn//lib/webauthn/authenticator_data.rb#83
  ...
  # source://webauthn//lib/webauthn/authenticator_data.rb#77
  def credential; end
  ...
  # source://webauthn//lib/webauthn/authenticator_data.rb#90
  def extension_data; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_data.rb#73
  ...
  # source://webauthn//lib/webauthn/authenticator_data.rb#134
  def base_length; end

  # source://webauthn//lib/webauthn/authenticator_data.rb#126
  def extension_data_length; end

  # source://webauthn//lib/webauthn/authenticator_data.rb#108
  def raw_extension_data; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_data.rb#104
...
class WebAuthn::AuthenticatorResponse
  ...
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#67
  ...
  # source://webauthn//lib/webauthn/authenticator_response.rb#117
  def rp_id_from_origin(expected_origin); end

  # @raise [NotImplementedError]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#121
  def type; end
  ...
  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#87
  def valid_challenge?(expected_challenge); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#91
  def valid_origin?(expected_origin); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#97
  def valid_rp_id?(rp_id); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#83
  def valid_token_binding?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#79
  def valid_type?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#109
  def valid_user_presence?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#113
  def valid_user_verified?; end

  # source://webauthn//lib/webauthn/authenticator_response.rb#69
...
class WebAuthn::Configuration
  ...
  # Returns the value of attribute relying_party.
  #
  # source://webauthn//lib/webauthn/configuration.rb#42
  def relying_party; end

  # source://webauthn//lib/webauthn/configuration.rb#56
  def rp_id; end

  # source://webauthn//lib/webauthn/configuration.rb#60
  def rp_id=(id); end
...
# source://webauthn//lib/webauthn/encoders.rb#8
module WebAuthn::Encoders
  class << self
    # source://webauthn//lib/webauthn/encoders.rb#10
    def lookup(encoding); end
  end
end

# source://webauthn//lib/webauthn/encoders.rb#24
class WebAuthn::Encoders::Base64Encoder
  class << self
    # source://webauthn//lib/webauthn/encoders.rb#29
    def decode(data); end

    # source://webauthn//lib/webauthn/encoders.rb#25
    def encode(data); end
  end
end

# source://webauthn//lib/webauthn/encoders.rb#34
class WebAuthn::Encoders::Base64UrlEncoder
  class << self
    # source://webauthn//lib/webauthn/encoders.rb#42
    def decode(data); end

    # source://webauthn//lib/webauthn/encoders.rb#35
    def encode(data); end
  end
end

# source://webauthn//lib/webauthn/encoders.rb#52
class WebAuthn::Encoders::NullEncoder
  class << self
    # source://webauthn//lib/webauthn/encoders.rb#57
    def decode(data); end

    # source://webauthn//lib/webauthn/encoders.rb#53
    def encode(data); end
  end
end
...
# source://webauthn//lib/webauthn/json_serializer.rb#4
module WebAuthn::JSONSerializer
  # Argument wildcard for Ruby on Rails controller automatic object JSON serialization
  #
  # source://webauthn//lib/webauthn/json_serializer.rb#6
  def as_json(*_arg0); end

  private

  # source://webauthn//lib/webauthn/json_serializer.rb#39
  def camelize(term); end

  # source://webauthn//lib/webauthn/json_serializer.rb#26
  def deep_camelize_keys(object); end

  # source://webauthn//lib/webauthn/json_serializer.rb#12
  def to_hash; end
end
...
class WebAuthn::PublicKeyCredential
  ...
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#23
  ...
  # source://webauthn//lib/webauthn/public_key_credential.rb#58
  def authenticator_extension_outputs; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#66
  def backed_up?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#62
  ...
  # source://webauthn//lib/webauthn/public_key_credential.rb#54
  def sign_count; end
  ...
  # source://webauthn//lib/webauthn/public_key_credential.rb#41
  def verify(challenge, *_args); end

  private

  # source://webauthn//lib/webauthn/public_key_credential.rb#86
  def authenticator_data; end

  # source://webauthn//lib/webauthn/public_key_credential.rb#90
  def encoder; end

  # Returns the value of attribute relying_party.
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#72
  def relying_party; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#82
  def valid_class?(challenge); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#78
  def valid_id?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#74
  def valid_type?; end

  class << self
    # source://webauthn//lib/webauthn/public_key_credential.rb#11
...
# source://webauthn//lib/webauthn/public_key_credential/entity.rb#5
class WebAuthn::PublicKeyCredential::Entity
  ...
  # source://webauthn//lib/webauthn/public_key_credential/entity.rb#16
  def attributes; end
end
...
class WebAuthn::PublicKeyCredential::Options
  ...
  #
  # source://webauthn//lib/webauthn/public_key_credential/options.rb#14
  def initialize(timeout: T.unsafe(nil), extensions: T.unsafe(nil), relying_party: T.unsafe(nil)); end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#20
  def challenge; end

  # Returns the value of attribute extensions.
  #
  # source://webauthn//lib/webauthn/public_key_credential/options.rb#12
  def extensions; end
  ...
  # source://webauthn//lib/webauthn/public_key_credential/options.rb#46
  def as_public_key_descriptors(ids); end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#26
  def attributes; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#42
  def default_extensions; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#38
  def default_timeout; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#30
  def encoder; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#34
  def raw_challenge; end
end

# source://webauthn//lib/webauthn/public_key_credential/options.rb#10
...
class WebAuthn::PublicKeyCredential::RequestOptions < ::WebAuthn::PublicKeyCredential::Options
  ...
  # source://webauthn//lib/webauthn/public_key_credential/request_options.rb#39
...
class WebAuthn::PublicKeyCredentialWithAssertion < ::WebAuthn::PublicKeyCredential
  # source://webauthn//lib/webauthn/public_key_credential_with_assertion.rb#33
  def raw_user_handle; end

  # source://webauthn//lib/webauthn/public_key_credential_with_assertion.rb#27
  def user_handle; end
  ...
  # source://webauthn//lib/webauthn/public_key_credential_with_assertion.rb#45
  def appid; end

  # source://webauthn//lib/webauthn/public_key_credential_with_assertion.rb#39
...
class WebAuthn::RelyingParty
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#46
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#57
  def attestation_root_certificates_finders; end

  # source://webauthn//lib/webauthn/relying_party.rb#65
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#61
  def encoder; end
  ...
  # Sets the attribute legacy_u2f_appid
  #
  # @param value the value to set the attribute legacy_u2f_appid to.
  #
  # source://webauthn//lib/webauthn/relying_party.rb#46
  ...
  # source://webauthn//lib/webauthn/relying_party.rb#94
  def options_for_authentication(**keyword_arguments); end

  # source://webauthn//lib/webauthn/relying_party.rb#79
  def options_for_registration(**keyword_arguments); end

  # DEPRECATED: This method will be removed in future.
  #
  # source://webauthn//lib/webauthn/relying_party.rb#125
  def origin; end

  # DEPRECATED: This method will be removed in future.
  #
  # source://webauthn//lib/webauthn/relying_party.rb#136
  ...
  # source://webauthn//lib/webauthn/relying_party.rb#101
...
# source://webauthn//lib/webauthn.rb#11

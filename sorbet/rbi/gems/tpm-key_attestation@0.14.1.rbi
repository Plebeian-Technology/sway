...
class TPM::AIKCertificate < ::SimpleDelegator
  # @return [Boolean]
  #
  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#32
  def conformant?; end
  ...
  # @return [Boolean]
  #
  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#65
  def empty_subject?; end

  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#79
  def extension(oid); end

  # @return [Boolean]
  #
  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#43
  def in_use?; end

  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#117
  def san_extension; end

  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#101
  def san_name; end

  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#83
  def tpm_manufacturer; end

  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#89
  def tpm_model; end

  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#95
  def tpm_version; end

  # @return [Boolean]
  #
  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#53
  def valid_basic_constraints?; end

  # @return [Boolean]
  #
  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#59
  def valid_extended_key_usage?; end

  # @return [Boolean]
  #
  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#69
  def valid_subject_alternative_name?; end

  # @return [Boolean]
  #
  # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#49
  def valid_version?; end

  class << self
    # source://tpm-key_attestation//lib/tpm/aik_certificate.rb#28
...
# source://tpm-key_attestation//lib/tpm/aik_certificate.rb#18
...
# source://tpm-key_attestation//lib/tpm/openssl_helper.rb#4
module TPM::OpenSSLHelper
  class << self
    # @return [Boolean]
    #
    # source://tpm-key_attestation//lib/tpm/openssl_helper.rb#5
...
class TPM::SAttest < ::BinData::Record
  class << self
    # source://tpm-key_attestation//lib/tpm/s_attest.rb#12
...
class TPM::TPublic < ::BinData::Record
  ...
  class << self
    # source://tpm-key_attestation//lib/tpm/t_public.rb#27
    def deserialize(io, *args, &block); end
  end
end

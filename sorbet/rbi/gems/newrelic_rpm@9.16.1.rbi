...
class DependencyDetection::Dependent
  ...
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#202
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#149
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#228
  def prepend_conflicts?; end
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#224
  def use_prepend?; end

  # returns only a valid value for instrumentation configuration
  # If user uses "enabled" it's converted to "auto"
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#181
  def valid_config_value(retrieved_value); end
end

# source://newrelic_rpm//lib/new_relic/dependency_detection.rb#171
DependencyDetection::Dependent::AUTO_CONFIG_VALUE = T.let(T.unsafe(nil), Symbol)

# source://newrelic_rpm//lib/new_relic/dependency_detection.rb#170
...
class NewRelic::Agent::Agent
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#68
  def initialize; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#77
  def init_basics; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#90
  def init_components; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#103
  def init_event_handlers; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#116
...
#
# source://newrelic_rpm//lib/new_relic/agent/agent.rb#131
module NewRelic::Agent::Agent::ClassMethods
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#134
  def instance; end
end
...
module NewRelic::Agent::Agent::InstanceMethods
  ...
  #   quickly if there is some kind of latency with the server.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#210
  def after_fork(options = T.unsafe(nil)); end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#241
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#340
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#225
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#309
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#269
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#257
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#322
  def control; end
end
...
module NewRelic::Agent::AgentHelpers::Connect
  ...
  # @param options [Hash]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#185
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#160
  ...
  # the connect service
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#98
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#85
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#91
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#74
  def handle_unrecoverable_agent_error(error); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#125
  def log_collector_messages(messages); end

  # Logs when we connect to the server, for debugging purposes
  # - makes sure we know if an agent has not connected
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#116
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#208
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#139
  def signal_connected; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#145
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#135
  def waited_on_connect?; end
end

# source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#131
...
module NewRelic::Agent::AgentHelpers::Startup
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#169
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#157
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#197
  def disabled?; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#151
  def has_correct_license_key?; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#139
...
class NewRelic::Agent::Configuration::YamlSource < ::NewRelic::Agent::Configuration::DottedHash
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#172
  def apply_aliases(config); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#135
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#150
  def is_boolean?(value); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#154
  def log_failure(*messages); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#94
  def process_erb(file); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#107
  def process_yaml(file, env, config, path); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#125
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#68
...
class NewRelic::Agent::Database::Statement
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#300
  def explainable?; end

  # source://newrelic_rpm//lib/new_relic/agent/database.rb#282
...
class NewRelic::Agent::NewRelicService
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#712
  def filtered_uri(uri); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#535
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#578
  def handle_serialization_error(method, e); end

  # @raise [ServerConnectionException]
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#503
  def handle_server_connection_exception(response, endpoint); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#514
  ...
  # server may return
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#562
  def invoke_remote(method, payload = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#700
  def invoke_remote_send_request(method, payload, data, encoding); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#554
  def license_key; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#645
  def log_response(response); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#679
  def marshal_payload(method, payload, options); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#693
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#655
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#607
  def record_size_supportability_metrics(method, size_bytes, item_count); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#587
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#525
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#637
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#671
  def user_agent; end
end

...
class PDF::Reader::CMap
  # source://pdf-reader//lib/pdf/reader/cmap.rb#57
  ...
  #
  #
  # source://pdf-reader//lib/pdf/reader/cmap.rb#123
...
class PDF::Reader::Font
  ...
  # source://pdf-reader//lib/pdf/reader/font.rb#269
  sig { params(obj: T::Hash[::Symbol, T.untyped]).void }
  def extract_descendants(obj); end

  # source://pdf-reader//lib/pdf/reader/font.rb#257
  sig { params(obj: T::Hash[::Symbol, T.untyped]).void }
  def extract_descriptor(obj); end

  # source://pdf-reader//lib/pdf/reader/font.rb#248
  sig { params(obj: T::Hash[::Symbol, T.untyped]).void }
  ...
  # source://pdf-reader//lib/pdf/reader/font.rb#284
  sig do
    params(
  ...
  # source://pdf-reader//lib/pdf/reader/font.rb#300
  sig { params(params: T.any(::Integer, ::String, T::Array[T.any(::Integer, ::String)])).returns(::String) }
  def to_utf8_via_encoding(params); end

  # source://pdf-reader//lib/pdf/reader/font.rb#316
...
class PDF::Reader::FormXObject
  ...
  def color_spaces(*_arg0, **_arg1, &_arg2); end
  ...
  def shadings(*_arg0, **_arg1, &_arg2); end
  ...
  def xobjects(*_arg0, **_arg1, &_arg2); end
...
class PDF::Reader::PageTextReceiver
  ...
  def begin_text_object(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#30
  def concatenate_matrix(*_arg0, **_arg1, &_arg2); end
  ...
  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#33
  def end_text_object(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#37
  def font_size(*_arg0, **_arg1, &_arg2); end
  ...
  def move_text_position(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#42
  def move_text_position_and_set_leading(*_arg0, **_arg1, &_arg2); end
  ...
  def move_to_start_of_next_line(*_arg0, **_arg1, &_arg2); end
  ...
  def restore_graphics_state(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#54
  def runs(opts = T.unsafe(nil)); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#27
  def save_graphics_state(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#36
  def set_character_spacing(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#36
  def set_horizontal_text_scaling(*_arg0, **_arg1, &_arg2); end
  ...
  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#37
  def set_text_font_and_size(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#38
  def set_text_leading(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#43
  def set_text_matrix_and_text_line_matrix(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#38
  def set_text_rendering_mode(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#39
  def set_text_rise(*_arg0, **_arg1, &_arg2); end

  # source://pdf-reader//lib/pdf/reader/page_text_receiver.rb#39
  def set_word_spacing(*_arg0, **_arg1, &_arg2); end

...
class RuboCop::Cop::FactoryBot::AssociationStyle < ::RuboCop::Cop::Base
  ...
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#97
  ...
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#109
  def implicit_association?(param0 = T.unsafe(nil)); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#83
  def on_send(node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#145
  def trait_name(param0); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#135
  ...
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#149
  def autocorrect(corrector, node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#157
  def autocorrect_to_explicit_style(corrector, node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#165
  def autocorrect_to_implicit_style(corrector, node); end

  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#175
  def bad?(node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#196
  def bad_associations_in(node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#202
  def children_of_factory_block(node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#214
  def factory_names_from_explicit(node); end

  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#186
  def keyword?(node); end

  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#224
  def non_implicit_association_method_name?(method_name); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#228
  def non_implicit_association_method_names; end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#241
  def options_for_autocorrect_to_implicit_style(node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#233
  def options_from_explicit(node); end

  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#250
...
# source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#77

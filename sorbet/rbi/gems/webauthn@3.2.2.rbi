...
class WebAuthn::AuthenticatorResponse
  ...
  # source://webauthn//lib/webauthn/authenticator_response.rb#56
  def client_data; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#50
  ...
  # source://webauthn//lib/webauthn/authenticator_response.rb#108
  def rp_id_from_origin(expected_origin); end

  # @raise [NotImplementedError]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#112
  def type; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#94
  def valid_authenticator_data?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#82
  def valid_challenge?(expected_challenge); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#86
  def valid_origin?(expected_origin); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#90
  def valid_rp_id?(rp_id); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#78
  def valid_token_binding?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#74
  def valid_type?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#100
  def valid_user_presence?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#104
  def valid_user_verified?; end

  # source://webauthn//lib/webauthn/authenticator_response.rb#64
...
class WebAuthn::Configuration
  ...
  # source://webauthn//lib/webauthn/configuration.rb#54
  def rp_id; end

  # source://webauthn//lib/webauthn/configuration.rb#58
  def rp_id=(id); end

  # source://webauthn//lib/webauthn/configuration.rb#46
  def rp_name; end

  # source://webauthn//lib/webauthn/configuration.rb#50
...
class WebAuthn::Encoder
  ...
  # source://webauthn//lib/webauthn/encoder.rb#36
  def decode(data); end
...
class WebAuthn::RelyingParty
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#44
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#55
  def attestation_root_certificates_finders; end

  # source://webauthn//lib/webauthn/relying_party.rb#63
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#59
  def encoder; end
  ...
  # source://webauthn//lib/webauthn/relying_party.rb#92
  def options_for_authentication(**keyword_arguments); end

  # source://webauthn//lib/webauthn/relying_party.rb#77
  ...
  # source://webauthn//lib/webauthn/relying_party.rb#99
  ...
  # source://webauthn//lib/webauthn/relying_party.rb#84

...
module Hotwire::Livereload
  class << self
    # source://hotwire-livereload//lib/hotwire/livereload/engine.rb#104
    ...
    # @return [Boolean]
    #
    # source://hotwire-livereload//lib/hotwire/livereload/engine.rb#108
    def server_process?; end

    # source://railties/7.1.3.2/lib/rails/engine.rb#401
    def table_name_prefix; end

    # source://hotwire-livereload//lib/hotwire/livereload/engine.rb#95

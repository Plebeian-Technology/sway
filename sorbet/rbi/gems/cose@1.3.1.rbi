...
class COSE::Key::EC2 < ::COSE::Key::CurveKey
  ...
  #
  # source://cose//lib/cose/key/ec2.rb#53
  def initialize(y: T.unsafe(nil), **keyword_arguments); end

  # source://cose//lib/cose/key/ec2.rb#111
  def curve; end

  # source://cose//lib/cose/key/ec2.rb#63
  def map; end

  # source://cose//lib/cose/key/ec2.rb#119
  def pad_coordinate(group, coordinate); end

  # source://cose//lib/cose/key/ec2.rb#70
  def to_pkey; end
  ...
  class << self
    # source://cose//lib/cose/key/ec2.rb#16
    def enforce_type(map); end

    # source://cose//lib/cose/key/ec2.rb#22
    def from_pkey(pkey); end

    # source://cose//lib/cose/key/ec2.rb#115
    def keyword_arguments_for_initialize(map); end
  end
end

...
module DependencyDetection
  ...
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#34
...
# source://newrelic_rpm//lib/new_relic/dependency_detection.rb#38
class DependencyDetection::Dependent
  # @return [Dependent] a new instance of Dependent
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#53
  def initialize; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#143
  def allowed_by_config?; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#167
  def auto_configured?; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#167
  def chain_configured?; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#100
  def chain_instrument(instrumenting_module, supportability_name = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#106
  def chain_instrument_target(target, instrumenting_module, supportability_name = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#126
  def check_dependencies; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#157
  def config_key; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#49
  def config_name; end
  ...
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#194
  def config_value; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#65
  def configure_as_unsatisfied; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#204
  def configure_with(new_config_name); end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#212
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#61
  def dependencies_satisfied?; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#139
  def depends_on(&block); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#147
  def deprecated_disabled_configured?; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#167
  def disabled_configured?; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#113
  def execute; end

  # Returns the value of attribute executed.
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#39
  def executed; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#45
  def executed!; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#208
  ...
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#83
  ...
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#180
  def fetch_config_value(key); end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#87
  ...
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#200
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#220
  def prepend_conflicts?; end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#94
  def prepend_instrument(target_class, instrumenting_module, supportability_name = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#76
  ...
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#187
  def update_config_value(use_prepend); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#216
  def use_prepend?; end

  # returns only a valid value for instrumentation configuration
  # If user uses "enabled" it's converted to "auto"
  #
  # source://newrelic_rpm//lib/new_relic/dependency_detection.rb#174
  def valid_config_value(retrieved_value); end
end

# source://newrelic_rpm//lib/new_relic/dependency_detection.rb#164
DependencyDetection::Dependent::AUTO_CONFIG_VALUE = T.let(T.unsafe(nil), Symbol)

# source://newrelic_rpm//lib/new_relic/dependency_detection.rb#163
...
module NewRelic::Agent
  ...
  # source://newrelic_rpm//lib/new_relic/agent.rb#832
  def add_custom_attributes(params); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#914
  def add_custom_log_attributes(params); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#872
  def add_custom_span_attributes(params); end

  # @api private
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#261
  def add_deferred_method_tracers_now; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#686
  def add_instrumentation(file_pattern); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#850
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#163
  def add_or_defer_method_tracer(receiver, method_name, metric_name, options); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#646
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#134
  def agent; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#142
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#324
  def base_name(klass_name); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#1085
  def browser_timing_header(nonce = T.unsafe(nil)); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#271
  def config; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#768
  def disable_all_tracing; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#793
  def disable_sql_recording; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#670
  def drop_buffered_data; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#122
  def error_group_callback; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#986
  def get_transaction_name; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#744
  def ignore_apdex; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#755
  def ignore_enduser; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#372
  def ignore_error_filter(&block); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#733
  def ignore_transaction; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#344
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#147
  def instance; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#1057
  def linking_metadata; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#123
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#151
  def logger; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#155
  def logger=(log); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#613
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#277
  def reset_config; end

  # source://newrelic_rpm//lib/new_relic/agent.rb#449
  ...
  # source://newrelic_rpm//lib/new_relic/agent.rb#717
  def set_sql_obfuscator(type = T.unsafe(nil), &block); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#975
  def set_transaction_name(name, options = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#930
  def set_user_id(user_id); end

  # source://newrelic_rpm//lib/new_relic/agent.rb#660
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#1017
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#1007
  ...
  class << self
    ...
    # @api private
    #
    # source://newrelic_rpm//lib/new_relic/agent.rb#225
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#117
...
#
# source://newrelic_rpm//lib/new_relic/agent/agent.rb#57
class NewRelic::Agent::Agent
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#70
  def initialize; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#136
  def refresh_attribute_filter; end

  private

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#79
  def init_basics; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#92
  def init_components; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#113
  def init_event_handlers; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#126
  def setup_attribute_filter; end

  class << self
    # source://newrelic_rpm//lib/new_relic/agent/agent.rb#58
    def config; end
  end
end
...
# instances
#
# source://newrelic_rpm//lib/new_relic/agent/agent.rb#151
module NewRelic::Agent::Agent::InstanceMethods
  # Returns the value of attribute adaptive_sampler.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#186
  def adaptive_sampler; end

  # Returns the value of attribute adaptive_sampler_remote_parent_not_sampled.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#188
  def adaptive_sampler_remote_parent_not_sampled; end

  # Returns the value of attribute adaptive_sampler_remote_parent_sampled.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#187
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#199
  def agent_id=(agent_id); end

  # Returns the value of attribute attribute_filter.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#185
  def attribute_filter; end

  # Returns the value of attribute custom_event_aggregator.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#181
  def custom_event_aggregator; end

  # Clear out the metric data, errors, and transaction traces, etc.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#302
  def drop_buffered_data; end

  # error collector is a simple collection of recorded errors
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#160
  ...
  # used only by resque
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#324
  def flush_pipe_data; end

  # the agent control health check file generator
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#153
  def health_check; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#252
  def install_pipe_service(channel_id); end

  # builder for JS agent scripts to inject
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#164
  def javascript_instrumentor; end

  # Returns the value of attribute log_event_aggregator.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#183
  def log_event_aggregator; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#351
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#237
  def needs_after_fork_work?; end

  # Pop the current trace execution status.  Restore trace execution status
  # to what it was before we pushed the current flag.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#297
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#291
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#320
  def reset_objects_with_locks; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#263
  def revert_to_default_configuration; end

  # Returns the value of attribute serverless_handler.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#189
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#280
  def set_record_sql(should_record); end

  # Returns the value of attribute span_event_aggregator.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#182
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#155
  def stats_engine; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#195
  def synthetics_event_aggregator; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#191
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#178
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#157
  def transaction_sampler; end

  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#268
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent.rb#333
  def control; end
end
...
module NewRelic::Agent::AgentHelpers::Connect
  ...
  # @param options [Hash]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#186
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#161
  ...
  # the connect service
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#99
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#86
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#92
  def event_harvest_config; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#68
  def handle_license_error(error); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#75
  def handle_unrecoverable_agent_error(error); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#126
  def log_collector_messages(messages); end

  # Logs when we connect to the server, for debugging purposes
  # - makes sure we know if an agent has not connected
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#117
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#56
  def log_error(error); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#49
  def note_connect_failure; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#211
  def retry_from_error?(e, opts); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#30
  def serverless?; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#37
  def should_connect?(force = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#140
  def signal_connected; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#146
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#136
  def waited_on_connect?; end
end

# source://newrelic_rpm//lib/new_relic/agent/agent_helpers/connect.rb#132
...
module NewRelic::Agent::AgentHelpers::Harvest
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/harvest.rb#131
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/harvest.rb#148
...
module NewRelic::Agent::AgentHelpers::Shutdown
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/shutdown.rb#45
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/shutdown.rb#63
  def shutdown_service; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/shutdown.rb#28
...
module NewRelic::Agent::AgentHelpers::StartWorkerThread
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/start_worker_thread.rb#109
  ...
  # the agent
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/start_worker_thread.rb#128
  ...
  # unknown state.
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/start_worker_thread.rb#98
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/start_worker_thread.rb#163
  def establish_fire_everies(data_harvest); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/start_worker_thread.rb#145
...
module NewRelic::Agent::AgentHelpers::Startup
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#175
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#113
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#123
  def connect_in_foreground; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#162
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#204
  def disabled?; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#143
  def has_license_key?; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#92
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#82
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#75
  def log_environment; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#96
  def log_ignore_url_regexes; end

  # Log startup information that we almost always want to know
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#67
  def log_startup; end
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#108
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#129
  def monitoring?; end
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_helpers/startup.rb#52
...
# source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#14
class NewRelic::Agent::AgentLogger
  include ::NewRelic::Agent::LogOnce

  # @return [AgentLogger] a new instance of AgentLogger
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#17
  def initialize(root = T.unsafe(nil), override_logger = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#44
  def debug(*msgs, &blk); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#32
  def error(*msgs, &blk); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#28
  def fatal(*msgs, &blk); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#40
  def info(*msgs, &blk); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#48
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#56
  def log_exception(level, e, backtrace_level = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#68
  def log_formatter=(formatter); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#36
  def warn(*msgs, &blk); end

  private

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#74
  def backtrace_from_exception(e); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#101
  def create_log(root, override_logger); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#115
  def create_log_to_file(root); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#131
  def create_null_logger; end

  # Don't allow agent logs into agent log forwarding for now
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#175
  def disable_log_instrumentation!; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#140
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#85
  def format_and_send(level, *msgs, &block); end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#179
  def gather_startup_logs; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#166
  def set_log_format!; end

  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#150
  def set_log_level!; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#135
  def wants_stdout?; end

  class << self
    # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#183
    def format_fatal_error(message); end

    # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#162
    def log_level_for(level); end
  end
end

# source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#154
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#88
class NewRelic::Agent::AutomaticTracerParseException < ::StandardError; end

# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#89
...
# source://newrelic_rpm//lib/new_relic/agent/aws.rb#7
module NewRelic::Agent::Aws
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/aws.rb#32
    def convert_access_key_to_account_id(access_key); end

    # source://newrelic_rpm//lib/new_relic/agent/aws.rb#46
    def convert_section(section); end

    # source://newrelic_rpm//lib/new_relic/agent/aws.rb#11
    def create_arn(service, resource, region, account_id); end

    # source://newrelic_rpm//lib/new_relic/agent/aws.rb#38
    def decode_to_hex(access_key); end

    # source://newrelic_rpm//lib/new_relic/agent/aws.rb#20
    def get_account_id(config); end
  end
end

# source://newrelic_rpm//lib/new_relic/agent/aws.rb#8
NewRelic::Agent::Aws::CHARACTERS = T.let(T.unsafe(nil), Array)

# source://newrelic_rpm//lib/new_relic/agent/aws.rb#9
...
class NewRelic::Agent::Configuration::EnvironmentSource < ::NewRelic::Agent::Configuration::DottedHash
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/environment_source.rb#87
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/environment_source.rb#95
  def serverless?; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/environment_source.rb#31
  def set_aliases(config_setting, value); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/environment_source.rb#61
  def set_config_file; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/environment_source.rb#41
  def set_dotted_alias(original_config_setting); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/environment_source.rb#50
  def set_log_file; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/environment_source.rb#65
...
class NewRelic::Agent::Configuration::HighSecuritySource < ::NewRelic::Agent::Configuration::DottedHash
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/high_security_source.rb#34
  def record_sql_setting(local_settings, key); end
end

# source://newrelic_rpm//lib/new_relic/agent/configuration/high_security_source.rb#30
...
# source://newrelic_rpm//lib/new_relic/agent/configuration/high_security_source.rb#32
...
# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#16
class NewRelic::Agent::Configuration::Manager
  # @return [Manager] a new instance of Manager
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#55
  def initialize; end

  # Defining these explicitly saves object allocations that we incur
  # if we use Forwardable and def_delegators.
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#43
  def [](key); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#61
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#256
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#149
  def config_category(klass); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#533
  def config_classes_for_testing; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#272
  def default_source; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#237
  def default_with_warning(key, value, msg); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#244
  def default_without_warning(key); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#519
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#157
  def evaluate_and_apply_transformations(key, value, category); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#132
  def fetch(key); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#323
  def finished_configuring?; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#327
  def flattened; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#181
  def handle_nil_type(key, value, category); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#47
  def has_key?(key); end
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#174
  def instrumentation?(type, value); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#281
  def invoke_callbacks(direction, source); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#51
  def keys; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#233
  def likely_transformed_already?(key, value); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#446
  def limit_number_of_labels(pairs); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#506
  def log_config(direction, source); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#413
  def make_label_hash(pairs, labels = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#502
  def new_cache; end
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#319
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#311
  def notify_server_source_added; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#529
  def num_configs_for_testing; end

  # permit an int to be supplied for a float based param and vice versa
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#194
  def numeric_conversion(value); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#461
  def parse_labels_from_dictionary; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#382
  def parse_labels_from_string; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#370
  def parsed_labels; end

  # @yield []
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#276
  def register_callback(key, &proc); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#83
  def remove_config(source); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#70
  def remove_config_type(sym); end

  # We only take the last value provided for a given label type key
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#456
  def remove_duplicates(pairs); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#100
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#482
  def reset_cache; end

  # Generally only useful during initial construction and tests
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#466
  def reset_to_defaults; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#124
  def source(key); end

  # permit a symbol to be supplied for a string based param and vice versa
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#199
  def string_conversion(value); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#350
  def to_collector_hash; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#432
  def truncate(text, key = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#203
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#395
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#539
  def config_stack; end
end

# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#19
...
# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#28
...
# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#367
NewRelic::Agent::Configuration::Manager::MAX_LABEL_COUNT = T.let(T.unsafe(nil), Integer)

# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#368
NewRelic::Agent::Configuration::Manager::MAX_LABEL_LENGTH = T.let(T.unsafe(nil), Integer)

# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#29
NewRelic::Agent::Configuration::Manager::NUMERIC_TYPES = T.let(T.unsafe(nil), Array)

# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#365
...
# source://newrelic_rpm//lib/new_relic/agent/configuration/manager.rb#32
...
#
# source://newrelic_rpm//lib/new_relic/agent/configuration/sampler_config_validator.rb#10
module NewRelic::Agent::Configuration::SamplerConfigValidator
  class << self
    # used for testing
    #
    # source://newrelic_rpm//lib/new_relic/agent/configuration/sampler_config_validator.rb#47
    def reset_warnings!; end

    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/configuration/sampler_config_validator.rb#42
    def valid_ratio?(ratio); end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/sampler_config_validator.rb#21
    def validate_sampler_strategy_with_ratio(strategy_key, ratio_key); end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/sampler_config_validator.rb#14
...
class NewRelic::Agent::Configuration::ServerSource < ::NewRelic::Agent::Configuration::DottedHash
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#35
  def initialize(connect_reply, existing_config = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#87
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#134
  def apply_feature_gates(merged_settings, connect_reply, existing_config); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#98
  def event_harvest_config_is_valid(connect_reply); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#112
  def filter_keys(merged_settings); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#70
  def fix_transaction_threshold(merged_settings); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#64
  def merge_agent_config_hash(merged_settings, connect_reply); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#56
  def merge_top_level_keys(merged_settings, connect_reply); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#154
  def ungated_value(key, merged_settings, existing_config); end
end

# source://newrelic_rpm//lib/new_relic/agent/configuration/server_source.rb#77
...
class NewRelic::Agent::Configuration::YamlSource < ::NewRelic::Agent::Configuration::DottedHash
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#50
  def failed?; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#177
  def apply_aliases(config); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#140
  def booleanify_values(config, *keys); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#164
  def dot_flattened(nested_hash, names = T.unsafe(nil), result = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#155
  def is_boolean?(value); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#159
  def log_failure(*messages); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#95
  def process_erb(file); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#112
  def process_yaml(file, env, config, path); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#130
  def substitute_transaction_threshold(config); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#56
  def validate_config_file_path(path); end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/yaml_source.rb#69
...
class NewRelic::Agent::Connect::ResponseHandler
  ...
  # source://newrelic_rpm//lib/new_relic/agent/connect/response_handler.rb#35
...
class NewRelic::Agent::CustomEventAggregator < ::NewRelic::Agent::EventAggregator
  ...
  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#25
  def record(type, attributes); end

  private

  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#86
  def after_harvest(metadata); end

  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#82
  def after_initialize; end

  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#59
  def create_custom_event_attributes(type, attributes); end

  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#50
  def create_event(type, priority, attributes); end

  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#105
  def note_dropped_event(type); end

  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#92
  def note_dropped_events(total_count, dropped_count); end

  # source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#98
...
# source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#17
NewRelic::Agent::CustomEventAggregator::MAX_ATTRIBUTE_COUNT = T.let(T.unsafe(nil), Integer)

# source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#18
NewRelic::Agent::CustomEventAggregator::MAX_ATTRIBUTE_SIZE = T.let(T.unsafe(nil), Integer)

# source://newrelic_rpm//lib/new_relic/agent/custom_event_aggregator.rb#19
...
module NewRelic::Agent::Database
  ...
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#129
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#141
  ...
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#109
  def explain_this_using_adapter_connection(statement, use_execute); end

  # source://newrelic_rpm//lib/new_relic/agent/database.rb#103
  ...
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#164
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#122
...
class NewRelic::Agent::Database::ConnectionManager
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#195
  def close_connections; end
  ...
  class << self
    ...
    # source://newrelic_rpm//lib/new_relic/agent/database.rb#173
    def allocate; end
...
# source://newrelic_rpm//lib/new_relic/agent/database.rb#148
...
# source://newrelic_rpm//lib/new_relic/agent/database.rb#161
...
class NewRelic::Agent::Database::Obfuscator
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/database/obfuscator.rb#20
  def initialize; end

  # source://newrelic_rpm//lib/new_relic/agent/database/obfuscator.rb#51
  def default_sql_obfuscator(sql); end

  # Returns the value of attribute obfuscator.
  #
  # source://newrelic_rpm//lib/new_relic/agent/database/obfuscator.rb#15
  def obfuscator; end

  # source://newrelic_rpm//lib/new_relic/agent/database/obfuscator.rb#24
  def reset; end
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/database/obfuscator.rb#39
  def set_sql_obfuscator(type, &block); end

  class << self
    private

    # source://newrelic_rpm//lib/new_relic/agent/database/obfuscator.rb#12
    def allocate; end
...
# source://newrelic_rpm//lib/new_relic/agent/database/obfuscator.rb#18
...
# source://newrelic_rpm//lib/new_relic/agent/database.rb#162
NewRelic::Agent::Database::SQL_COMMENT_REGEX = T.let(T.unsafe(nil), Regexp)

# source://newrelic_rpm//lib/new_relic/agent/database.rb#208
class NewRelic::Agent::Database::Statement
  ...
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#267
  def append_sql(new_sql); end

  # Returns the value of attribute binds.
  #
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#211
  def binds; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/database.rb#251
  def explain; end
...
module NewRelic::Agent::Datastores
  class << self
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/datastores.rb#160
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/datastores.rb#190
    ...
    #   e.g. "FauxDB"
    #
    # source://newrelic_rpm//lib/new_relic/agent/datastores.rb#108
...
class NewRelic::Agent::DistributedTracePayload
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/distributed_trace_payload.rb#154
  def http_safe; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/distributed_trace_payload.rb#106
  def id; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/distributed_trace_payload.rb#118
  def sampled?; end
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/distributed_trace_payload.rb#125
  def text; end
...
module NewRelic::Agent::DistributedTracing
  ...
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing.rb#97
  def accept_distributed_trace_headers(headers, transport_type = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing.rb#42
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing.rb#138
  def has_variant_key?(key, variants); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing.rb#142
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#1035
NewRelic::Agent::ENTITY_GUID_KEY = T.let(T.unsafe(nil), String)

# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#1033
NewRelic::Agent::ENTITY_NAME_KEY = T.let(T.unsafe(nil), String)

# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#1038
NewRelic::Agent::ENTITY_TYPE = T.let(T.unsafe(nil), String)

# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#1034
...
class NewRelic::Agent::ErrorCollector
  ...
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#181
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#125
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#143
  def exception_is_java_object?(exception); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#147
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#230
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#195
  def increment_error_count!(state, exception, options = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#208
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#253
  def notice_error(exception, options = T.unsafe(nil), span_id = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#239
  ...
  # not exist
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#225
  def sense_method(object, method); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#215
  def skip_notice_error?(exception, status_code = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#163
  def tag_exception(exception); end

  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#153
  def tag_exception_using(ivar, exception); end

  # source://newrelic_rpm//lib/new_relic/agent/error_collector.rb#276
...
class NewRelic::Agent::EventAggregator
  ...
  class << self
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/event_aggregator.rb#32
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#85
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#92
class NewRelic::Agent::ForceRestartException < ::StandardError
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent.rb#93
  def message; end
end
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#1036
...
# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#7
class NewRelic::Agent::HealthCheck
  # @return [HealthCheck] a new instance of HealthCheck
  #
  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#8
  def initialize; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#31
  def create_and_run_health_check_loop; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#58
  def healthy?; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#51
  def update_status(status, options = T.unsafe(nil)); end

  private

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#94
  def contents; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#112
  def file_name; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#125
  def health_checks_enabled?; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#104
  def last_error; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#108
  def nano_time; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#74
  def set_delivery_location; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#64
  def set_enabled; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#85
  def set_frequency; end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#129
  def update_message(options); end

  # source://newrelic_rpm//lib/new_relic/agent/health_check.rb#116
  def write_file; end
end

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#26
NewRelic::Agent::HealthCheck::AGENT_DISABLED = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#24
NewRelic::Agent::HealthCheck::APP_NAME_EXCEEDED = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#27
NewRelic::Agent::HealthCheck::FAILED_TO_CONNECT = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#28
NewRelic::Agent::HealthCheck::FAILED_TO_PARSE_CONFIG = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#21
NewRelic::Agent::HealthCheck::FORCED_DISCONNECT = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#18
NewRelic::Agent::HealthCheck::HEALTHY = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#22
NewRelic::Agent::HealthCheck::HTTP_ERROR = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#19
NewRelic::Agent::HealthCheck::INVALID_LICENSE_KEY = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#23
NewRelic::Agent::HealthCheck::MISSING_APP_NAME = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#20
NewRelic::Agent::HealthCheck::MISSING_LICENSE_KEY = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#25
NewRelic::Agent::HealthCheck::PROXY_CONFIG_ERROR = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/health_check.rb#29
...
class NewRelic::Agent::Heap
  ...
  # source://newrelic_rpm//lib/new_relic/agent/heap.rb#66
  def <<(item); end
...
# source://newrelic_rpm//lib/new_relic/agent/monitors/inbound_request_monitor.rb#17
class NewRelic::Agent::InboundRequestMonitor
  # @return [InboundRequestMonitor] a new instance of InboundRequestMonitor
  #
  # source://newrelic_rpm//lib/new_relic/agent/monitors/inbound_request_monitor.rb#20
  def initialize(events); end

  # source://newrelic_rpm//lib/new_relic/agent/monitors/inbound_request_monitor.rb#32
  ...
  # source://newrelic_rpm//lib/new_relic/agent/monitors/inbound_request_monitor.rb#28
...
# source://newrelic_rpm//lib/new_relic/agent/instrumentation/active_support_subscriber.rb#10
class NewRelic::Agent::Instrumentation::ActiveSupportSubscriber < ::NewRelic::Agent::Instrumentation::NotificationsSubscriber
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/active_support_subscriber.rb#29
  def add_segment_params(segment, payload); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/active_support_subscriber.rb#43
  def method_name(name); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/active_support_subscriber.rb#37
  def metric_name(name, payload); end
end

# source://newrelic_rpm//lib/new_relic/agent/instrumentation/active_support_subscriber.rb#11
...
module NewRelic::Agent::Instrumentation::ControllerInstrumentation
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#358
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#427
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#439
  def ignore_enduser?; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#400
  def newrelic_request(args); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#414
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#412
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#463
  def _is_filtered?(key); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#445
  def create_transaction_options(trace_options, category, state, queue_start_time); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#477
...
module NewRelic::Agent::Instrumentation::ControllerInstrumentation::ClassMethods
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#168
  def add_transaction_tracer(method, options = T.unsafe(nil)); end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#226
  def already_added_transaction_tracer?(target, with_method_name); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#221
  def build_method_names(traced_method, punctuation); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#207
  def generate_argument_list(options); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#60
  def newrelic_ignore(specifiers = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#72
  def newrelic_ignore_apdex(specifiers = T.unsafe(nil)); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#84
  def newrelic_ignore_aspect(property, specifiers = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#79
  def newrelic_ignore_enduser(specifiers = T.unsafe(nil)); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#109
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#105
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#233
class NewRelic::Agent::Instrumentation::ControllerInstrumentation::TransactionNamer
  class << self
    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#278
    def class_name(traced_obj, options = T.unsafe(nil)); end

    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#234
    def name_for(txn, traced_obj, category, options = T.unsafe(nil)); end

    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#261
    def path_name(traced_obj, options = T.unsafe(nil)); end

    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/instrumentation/controller_instrumentation.rb#240
...
# source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#8
class NewRelic::Agent::Instrumentation::NotificationsSubscriber
  # @return [NotificationsSubscriber] a new instance of NotificationsSubscriber
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#9
  def initialize; end

  # for subclasses
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#84
  def add_segment_params(segment, payload); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#117
  def define_exception_method; end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#60
  def finish(name, id, payload); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#74
  def finish_segment(id, payload); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#93
  def log_notification_error(error, name, event_type); end

  # for subclasses
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#89
  def metric_name(name, payload); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#104
  def pop_segment(id); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#100
  def push_segment(id, segment); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#109
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#52
  def start(name, id, payload); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#68
  def start_segment(name, id, payload); end

  # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#113
  def state; end

  class << self
    # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#18
    def find_all_subscribers; end

    # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#42
    def subscribe(pattern); end

    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/instrumentation/notifications_subscriber.rb#14
    def subscribed?; end
  end
end
...
class NewRelic::Agent::JavaScriptInstrumentor
  ...
  # source://newrelic_rpm//lib/new_relic/agent/javascript_instrumentor.rb#171
  ...
  # source://newrelic_rpm//lib/new_relic/agent/javascript_instrumentor.rb#196
  def append_agent_attributes!(txn, atts); end

  # source://newrelic_rpm//lib/new_relic/agent/javascript_instrumentor.rb#184
  ...
  # source://newrelic_rpm//lib/new_relic/agent/javascript_instrumentor.rb#203
...
# source://newrelic_rpm//lib/new_relic/agent/llm.rb#13
class NewRelic::Agent::LLM
  class << self
    ...
    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/llm.rb#23
    def exempt_event_attribute?(type, key); end

    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/llm.rb#18
    def instrumentation_enabled?; end

    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/llm.rb#30
    def openai?; end
    ...
    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/llm.rb#36
    def openai_parent?(segment); end

    # source://newrelic_rpm//lib/new_relic/agent/llm.rb#42
    def populate_openai_response_headers(response, parent); end
  end
end

# source://newrelic_rpm//lib/new_relic/agent/llm.rb#15
NewRelic::Agent::LLM::CONTENT = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/llm.rb#14
NewRelic::Agent::LLM::INPUT = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/llm.rb#16
NewRelic::Agent::LLM::SEGMENT_PATTERN = T.let(T.unsafe(nil), Regexp)

# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#114
NewRelic::Agent::LLM_FEEDBACK_MESSAGE = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent.rb#82
...
# source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#7
module NewRelic::Agent::Llm; end

# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_message.rb#8
class NewRelic::Agent::Llm::ChatCompletionMessage < ::NewRelic::Agent::Llm::LlmEvent
  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_message.rb#15
  def attributes; end

  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_message.rb#13
  ...
  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_message.rb#19
  def event_name; end
...
# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_message.rb#9
NewRelic::Agent::Llm::ChatCompletionMessage::ATTRIBUTES = T.let(T.unsafe(nil), Array)

# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_message.rb#11
NewRelic::Agent::Llm::ChatCompletionMessage::EVENT_NAME = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#10
class NewRelic::Agent::Llm::ChatCompletionSummary < ::NewRelic::Agent::Llm::LlmEvent
  include ::NewRelic::Agent::Llm::ResponseHeaders

  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#31
  def attribute_name_exceptions; end

  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#27
  def attributes; end

  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#25
  def duration; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#39
  def error_attributes(exception); end

  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#35
  def event_name; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#47
  def error_attributes_from_response(exception, attrs); end
end

# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#13
NewRelic::Agent::Llm::ChatCompletionSummary::ATTRIBUTES = T.let(T.unsafe(nil), Array)

# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#16
NewRelic::Agent::Llm::ChatCompletionSummary::ATTRIBUTE_NAME_EXCEPTIONS = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#22
NewRelic::Agent::Llm::ChatCompletionSummary::ERROR_COMPLETION_ID = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/llm/chat_completion_summary.rb#23
NewRelic::Agent::Llm::ChatCompletionSummary::EVENT_NAME = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#8
class NewRelic::Agent::Llm::Embedding < ::NewRelic::Agent::Llm::LlmEvent
  include ::NewRelic::Agent::Llm::ResponseHeaders

  # source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#24
  def attribute_name_exceptions; end

  # source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#20
  def attributes; end

  # source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#18
  def duration; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#32
  def error_attributes(exception); end

  # source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#28
  def event_name; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#41
  def error_attributes_from_response(exception, attrs); end
end

# source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#11
NewRelic::Agent::Llm::Embedding::ATTRIBUTES = T.let(T.unsafe(nil), Array)

# source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#12
NewRelic::Agent::Llm::Embedding::ATTRIBUTE_NAME_EXCEPTIONS = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#15
NewRelic::Agent::Llm::Embedding::ERROR_EMBEDDING_ID = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/llm/embedding.rb#16
NewRelic::Agent::Llm::Embedding::EVENT_NAME = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#8
class NewRelic::Agent::Llm::LlmEvent
  ...
  #
  # @return [LlmEvent] a new instance of LlmEvent
  #
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#38
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#74
  def attribute_name_exceptions; end

  # Subclasses define an attributes method to concatenate attributes
  # defined across their ancestors and other modules
  #
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#62
  def attributes; end

  # Subclasses that add attributes to noticed errors will override this method
  #
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#83
  def error_attributes(exception); end

  # All subclasses use event_attributes to get a full hash of all
  # attributes and their values
  #
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#51
  def event_attributes; end

  # Subclasses that record events will override this method
  #
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#67
  def event_name; end

  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#27
  def id; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#78
  def record; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#89
  def replace_attr_with_string(attr); end

  class << self
    # source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#29
...
#
# source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#14
...
#
# source://newrelic_rpm//lib/new_relic/agent/llm/llm_event.rb#11
...
module NewRelic::Agent::Llm::ResponseHeaders
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/llm/response_headers.rb#46
...
class NewRelic::Agent::Logging::DecoratingLogger < ::ActiveSupport::Logger
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/logging.rb#163
...
module NewRelic::Agent::MethodTracer
  ...
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#71
  def trace_execution_scoped(metric_names, options = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#88
...
module NewRelic::Agent::MethodTracer::ClassMethods
  ...
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#249
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#256
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#269
  def _nr_add_method_tracer_now(method_name, metric_name, options); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#306
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#296
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#105
module NewRelic::Agent::MethodTracer::ClassMethods::AddMethodTracer
  # for testing only
  #
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#167
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#137
  def _nr_default_metric_name(method_name); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#173
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#162
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#114
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#155
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#145
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent/method_tracer.rb#108
...
# source://newrelic_rpm//lib/new_relic/agent/monitors.rb#13
...
class NewRelic::Agent::NewRelicService
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#39
  def initialize(license_key = T.unsafe(nil), collector = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#159
  def agent_command_results(results); end

  # Returns the value of attribute agent_id.
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#37
  def agent_id; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#73
  def agent_id=(id); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#163
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#108
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#357
  def cert_file_path; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#251
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#196
  def compress_request_if_needed(data, endpoint); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#81
  def connect(settings = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#346
  def create_and_start_http_connection; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#320
  def create_http_connection; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#169
  def custom_event_data(data); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#133
  def error_data(unsent_errors); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#180
  def error_event_data(data); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#246
  def establish_shared_connection; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#102
  def force_restart; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#155
  def get_agent_commands; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#259
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#277
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#119
  def metric_data(stats_hash); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#92
  def preconnect; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#55
  def prep_audit_logger; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#329
  def prep_connection; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#62
  def prep_marshaller; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#336
  def prep_proxy_connection; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#151
  def profile_data(profile); end

  # Returns the value of attribute request_timeout.
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#36
  ...
  # @raise [ArgumentError]
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#213
  def session(&block); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#232
  def session_with_keepalive(&block); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#237
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#285
  def setup_connection_for_ssl(conn); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#310
  def setup_connection_timeouts(conn); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#98
  def shutdown(time); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#188
  def span_event_data(data); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#146
  def sql_trace_data(sql_traces); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#263
  def ssl_cert_store; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#305
  def start_connection(conn); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#141
  def transaction_sample_data(traces); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#364
  def valid_to_marshal?(data); end

  private

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#423
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#583
  def check_post_size(post_string, endpoint); end

  # A shorthand for NewRelic::Control.instance
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#375
  def control; end

  # Decompresses the response from the server, if it is gzip
  # encoded, otherwise returns it verbatim
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#629
  def decompress_response(response); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#680
  def filtered_uri(uri); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#499
  def generate_remote_method_uri(method); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#429
  def handle_error_response(response, endpoint); end

  # @raise [ForceDisconnectException]
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#483
  def handle_gone_response(response, endpoint); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#542
  def handle_serialization_error(method, e); end

  # @raise [ServerConnectionException]
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#467
  def handle_server_connection_exception(response, endpoint); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#478
  def handle_unauthorized_error_response(response, endpoint); end

  # @raise [UnrecoverableServerException]
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#472
  ...
  # server may return
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#526
  def invoke_remote(method, payload = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#668
  def invoke_remote_send_request(method, payload, data, encoding); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#518
  def license_key; end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#613
  def log_response(response); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#647
  ...
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#388
  def prep_request(opts); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#623
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#619
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#571
  def record_size_supportability_metrics(method, size_bytes, item_count); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#551
  def record_timing_supportability_metrics(method, start_ts, serialize_finish_ts, request_send_ts, response_check_ts); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#402
  def relay_request(request, opts); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#489
  def remote_method_uri(method); end

  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#493
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#601
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#639
  def user_agent; end
end
...
#
# source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#20
...
module NewRelic::Agent::NewRelicService::Encoders::Base64CompressedJSON
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/new_relic_service/encoders.rb#29
...
#
# source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#23
...
#
# source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#34
...
#
# source://newrelic_rpm//lib/new_relic/agent/new_relic_service.rb#16
...
# source://newrelic_rpm//lib/new_relic/agent/opentelemetry_bridge.rb#7
...
class NewRelic::Agent::PipeService
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/pipe_service.rb#74
  def valid_to_marshal?(data); end

  private

  # source://newrelic_rpm//lib/new_relic/agent/pipe_service.rb#87
  def marshal_payload(data); end

  # source://newrelic_rpm//lib/new_relic/agent/pipe_service.rb#91
...
class NewRelic::Agent::PrioritySampledBuffer < ::NewRelic::Agent::EventBuffer
  ...
  # expects priority and a block, or an event as a hash with a `priority` key.
  #
  # source://newrelic_rpm//lib/new_relic/agent/priority_sampled_buffer.rb#49
...
class NewRelic::Agent::RulesEngine
  ...
  # source://newrelic_rpm//lib/new_relic/agent/rules_engine.rb#18
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#1032
NewRelic::Agent::SPAN_ID_KEY = T.let(T.unsafe(nil), String)

# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#330
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#110
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#100
class NewRelic::Agent::ServerConnectionException < ::StandardError; end

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#13
class NewRelic::Agent::ServerlessHandler
  # @return [ServerlessHandler] a new instance of ServerlessHandler
  #
  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#32
  def initialize; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#93
  def error_data(errors); end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#38
  def invoke_lambda_function_with_new_relic(event:, context:, method_name:, namespace: T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#67
  def metric_data(stats_hash); end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#61
  def store_payload(method, payload); end

  private

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#373
  def add_agent_attribute(attribute, value); end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#249
  def add_agent_attributes; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#294
  def add_event_source_attributes; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#260
  def add_http_attributes; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#277
  def api_gateway_event?; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#128
  def category; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#388
  def cold?; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#161
  def determine_api_gateway_version; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#320
  def event_source_arn; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#355
  def event_source_arn_for_records; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#343
  def event_source_event_info; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#124
  def function_name; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#105
  def harvest!; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#239
  def headers_from_event; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#192
  def http_uri(info); end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#219
  def info_for_api_gateway_v1; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#209
  def info_for_api_gateway_v2; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#111
  def metadata; end

  # New Relic serverless payload v1
  #
  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#144
  def payload_v1; end

  # New Relic serverless payload v2
  #
  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#153
  def payload_v2; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#99
  def prep_transaction; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#181
  def process_api_gateway_info; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#227
  def process_headers; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#377
  def process_response(response); end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#395
  def reset!; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#243
  def use_named_pipe?; end

  # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#133
  def write_output; end

  class << self
    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#28
    def env_var_set?; end
  end
end

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#14
NewRelic::Agent::ServerlessHandler::AGENT_ATTRIBUTE_DESTINATIONS = T.let(T.unsafe(nil), Integer)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#25
NewRelic::Agent::ServerlessHandler::DIGIT = T.let(T.unsafe(nil), Regexp)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#26
NewRelic::Agent::ServerlessHandler::EVENT_SOURCES = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#16
NewRelic::Agent::ServerlessHandler::EXECUTION_ENVIRONMENT = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#23
NewRelic::Agent::ServerlessHandler::FUNCTION_NAME = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#18
NewRelic::Agent::ServerlessHandler::LAMBDA_ENVIRONMENT_VARIABLE = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#17
NewRelic::Agent::ServerlessHandler::LAMBDA_MARKER = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#19
NewRelic::Agent::ServerlessHandler::METHOD_BLOCKLIST = T.let(T.unsafe(nil), Array)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#21
NewRelic::Agent::ServerlessHandler::NAMED_PIPE = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#24
NewRelic::Agent::ServerlessHandler::PAYLOAD_VERSION = T.let(T.unsafe(nil), Integer)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler.rb#22
...
#
# source://newrelic_rpm//lib/new_relic/agent/serverless_handler_event_sources.rb#22
class NewRelic::Agent::ServerlessHandlerEventSources
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/serverless_handler_event_sources.rb#26
    def to_hash; end

    # source://newrelic_rpm//lib/new_relic/agent/serverless_handler_event_sources.rb#36
    def transform(value); end
  end
end

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler_event_sources.rb#24
NewRelic::Agent::ServerlessHandlerEventSources::JSON_RAW = T.let(T.unsafe(nil), Hash)

# source://newrelic_rpm//lib/new_relic/agent/serverless_handler_event_sources.rb#23
NewRelic::Agent::ServerlessHandlerEventSources::JSON_SOURCE = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#205
class NewRelic::Agent::SlowSql
  # @return [SlowSql] a new instance of SlowSql
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#211
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#208
  def duration; end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#246
  def explain; end

  # Returns the value of attribute metric_name.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#207
  def metric_name; end
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#253
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#206
  def statement; end
end
...
module NewRelic::Agent::SpanEventPrimitive
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#61
  ...
  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#75
  def for_external_request_segment(segment); end

  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#68
  def for_segment(segment); end

  private

  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#195
  def agent_attributes(segment); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#226
  def allowed?(key); end

  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#178
  def custom_attributes(segment); end

  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#135
  ...
  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#213
  def milliseconds_since_epoch(segment); end

  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#205
  def parent_guid(segment); end

  # source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#217
...
# source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#55
...
# source://newrelic_rpm//lib/new_relic/agent/span_event_primitive.rb#54
...
class NewRelic::Agent::SqlSampler
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#127
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#166
  def harvest!; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#153
  def merge!(sql_traces); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#139
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#178
  def reset!; end
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#125
NewRelic::Agent::SqlSampler::PRIORITY = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#258
class NewRelic::Agent::SqlTrace < ::NewRelic::Agent::Stats
  include ::NewRelic::Coerce

  # @return [SqlTrace] a new instance of SqlTrace
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#267
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#263
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#302
  def need_to_obfuscate?; end

  # Returns the value of attribute params.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#264
  def params; end

  # Returns the value of attribute path.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#259
  def path; end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#296
  def prepare_to_send; end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#275
  def set_primary(slow_sql, path, uri); end

  # Returns the value of attribute slow_sql.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#265
  def slow_sql; end

  # Returns the value of attribute sql.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#262
  def sql; end

  # Returns the value of attribute sql_id.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#261
  def sql_id; end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#312
  def to_collector_array(encoder); end

  # Returns the value of attribute url.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#260
  def url; end
...
class NewRelic::Agent::StartupLogger < ::NewRelic::Agent::MemoryLogger
  ...
  class << self
    ...
    # source://newrelic_rpm//lib/new_relic/agent/agent_logger.rb#191
    def allocate; end
...
class NewRelic::Agent::Stats
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats.rb#140
  def apdex_f; end

  # Returns the value of attribute call_count.
  # Apdex-related accessors
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats.rb#138
  def apdex_s; end

  # Returns the value of attribute total_call_time.
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats.rb#139
  def apdex_t; end
  ...
  # its data to the NewRelic server
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats.rb#109
...
class NewRelic::Agent::StatsEngine
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#16
  def initialize; end

  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#161
  def apply_rules_to_metric_data(rules_engine, stats_hash); end

  # For use by test code only.
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#188
  def clear_stats; end

  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#173
  def coerce_to_metric_spec_array(metric_names_or_specs, scope); end

  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#153
  def harvest!; end

  # merge data from previous harvests into this stats engine
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#140
  def merge!(other_stats_hash); end

  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#147
  def merge_transaction_metrics!(txn_metrics, scope); end

  # Returns the value of attribute metric_rules.
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#14
  ...
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#105
  ...
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#69
  def record_unscoped_metrics(state, metric_names, value = T.unsafe(nil), aux = T.unsafe(nil), &blk); end

  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#131
  def reset!; end
  ...
  # @api private
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#100
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#124
  ...
  # @api private
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#64
  def tl_record_unscoped_metrics(metric_names, value = T.unsafe(nil), aux = T.unsafe(nil), &blk); end

  # For use by test code only.
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#194
  def to_h; end

  # All access to the @stats_hash ivar should be funnelled through this
  # method to ensure thread-safety.
  #
  # source://newrelic_rpm//lib/new_relic/agent/stats_engine.rb#24
...
class NewRelic::Agent::SyntheticsMonitor < ::NewRelic::Agent::InboundRequestMonitor
  ...
  # THREAD_LOCAL_ACCESS
  #
  # source://newrelic_rpm//lib/new_relic/agent/monitors/synthetics_monitor.rb#19
  def on_before_call(request); end

  # source://newrelic_rpm//lib/new_relic/agent/monitors/synthetics_monitor.rb#15
  def on_finished_configuring(events); end

  class << self
    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/monitors/synthetics_monitor.rb#46
    def is_supported_version?(incoming_payload); end

    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/monitors/synthetics_monitor.rb#50
    def is_trusted?(incoming_payload); end

    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/monitors/synthetics_monitor.rb#55
    def is_valid_payload?(incoming_payload); end

    # source://newrelic_rpm//lib/new_relic/agent/monitors/synthetics_monitor.rb#59
...
module NewRelic::Agent::SystemInfo
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#324
    def boot_id; end
    ...
    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#54
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#205
    def docker_container_id; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#217
    def docker_container_id_for_cgroupsv2; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#50
    ...
    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#181
    def num_logical_processors; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#179
    def num_physical_cores; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#177
    def num_physical_packages; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#22
    def os_distribution; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#187
    def os_version; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#261
    def parse_cgroup_ids(cgroup_info); end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#123
    def parse_cpuinfo(cpuinfo); end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#224
    def parse_docker_container_id(cgroup_info); end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#315
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#282
    def proc_try_read(path); end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#183
    def processor_arch; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#58
    def processor_info; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#100
    def processor_info_bsd; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#77
    def processor_info_darwin; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#95
    def processor_info_linux; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#301
    def ram_in_mib; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#108
    def remove_bad_values; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#18
    def ruby_os_identifier; end

    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#118
    def sysctl_value(name); end

    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/system_info.rb#32
    def windows?; end
  end
end
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#1031
...
class NewRelic::Agent::Threading::AgentThread
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/threading/agent_thread.rb#71
    def backing_thread_class; end

    # source://newrelic_rpm//lib/new_relic/agent/threading/agent_thread.rb#75
    def backing_thread_class=(clazz); end

    # THREAD_LOCAL_ACCESS
    #
    # source://newrelic_rpm//lib/new_relic/agent/threading/agent_thread.rb#38
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/threading/agent_thread.rb#34
    def list; end

    # source://newrelic_rpm//lib/new_relic/agent/threading/agent_thread.rb#55
...
class NewRelic::Agent::TraceContextPayload
  ...
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/trace_context_payload.rb#109
  def parent_type; end
  ...
  # Returns the value of attribute sampled.
  #
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/trace_context_payload.rb#84
  def sampled?; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/trace_context_payload.rb#123
  def to_s; end
...
# @api private
#
# source://newrelic_rpm//lib/new_relic/agent/distributed_tracing/trace_context_payload.rb#107
...
class NewRelic::Agent::Tracer
  class << self
    ...
    # @return [Boolean]
    #
    # source://newrelic_rpm//lib/new_relic/agent/tracer.rb#74
    def sampled?; end
    ...
    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/tracer.rb#62
    def span_id; end
    ...
    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/tracer.rb#411
    def tl_clear; end

    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/tracer.rb#25
    def tl_get; end
    ...
    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/tracer.rb#405
    ...
    # @api public
    #
    # source://newrelic_rpm//lib/new_relic/agent/tracer.rb#52
    def trace_id; end
...
class NewRelic::Agent::Tracer::State
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/tracer.rb#500
  def tracing_enabled?; end
...
class NewRelic::Agent::Transaction
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#529
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#921
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#887
  def apdex_t; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#618
  def assign_agent_attributes; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#643
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#541
  def background_summary_metrics; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#412
  def best_name; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#676
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#684
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#589
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#479
  def create_initial_segment(options = T.unsafe(nil)); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#505
  def create_nested_segment(category, options); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#484
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#379
  def default_name=(name); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#330
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#554
  def finish; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#475
  def finished?; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#431
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#850
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#957
  def ignore!; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#961
  def ignore?; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#965
  def ignore_apdex!; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#969
  def ignore_apdex?; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#973
  def ignore_enduser!; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#977
  def ignore_enduser?; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#981
  def ignore_trace?; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#722
  def include_guid?; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#408
  def influences_transaction_name?(category); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#471
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#726
  def is_synthetics_request?; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#951
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#403
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#790
  def merge_metrics; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#383
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#450
  def name_frozen?; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#550
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#813
  def notice_error(error, options = T.unsafe(nil)); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#375
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#334
  def priority; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#835
  def queue_time; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#802
  def record_exception(exception, options, error_recorded); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#794
  def record_exceptions; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#831
  def record_log_events; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#839
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#693
  def record_summary_metrics(outermost_node_name); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#827
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#345
  def referer; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#349
  def request_path; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#353
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#701
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#387
  def set_default_transaction_name(name, category); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#396
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#454
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#533
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#755
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#750
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#740
  def synthetics_resource_id; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#730
  def synthetics_version; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#896
  def threshold; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#326
  def trace_id=(value); end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#311
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#420
  def transaction_name; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#891
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#1010
  def agent; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#994
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#1018
  def sql_sampler; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#1014
  def transaction_sampler; end
...
class NewRelic::Agent::Transaction::AbstractSegment
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#129
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#112
  def children_time_ranges?; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#133
  def code_attributes; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#120
  def code_information=(info = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#116
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#94
  def finalize; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#66
  def finish; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#78
  def finished?; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#144
  def inspect; end

  # Returns the value of attribute llm_event.
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#23
  def llm_event; end

  # Sets the attribute llm_event
  #
  # @param value the value to set the attribute llm_event to.
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#23
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#165
  def notice_error(exception, options = T.unsafe(nil)); end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#176
  def noticed_error_attributes; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#100
  def params; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#104
  def params?; end
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#82
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#90
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#86
  def record_scoped_metric?; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#155
  def set_noticed_error(noticed_error); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#59
  def start; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#108
  def time_range; end
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#152
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#197
  def child_complete(segment); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#190
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#213
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#184
  def range_recorded=(_arg0); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#186
  def range_recorded?; end

  private

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#231
  def add_child_timing(segment); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#235
  def force_finish; end

  # for segment callback usage info, see self.set_segment_callback
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#337
  def invoke_callback; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#279
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#308
  def overlapping_duration; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#287
  def range_overlap(range); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#283
  def ranges_intersect?(r1, r2); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#256
  def record_child_time(child); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#269
  def record_child_time_as_number(child); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#264
  def record_child_time_as_range(child); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#273
  def record_exclusive_duration; end

  # @raise [NotImplementedError]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#248
  def record_metrics; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#242
  def run_complete_callbacks; end

  # callback for subclasses to override
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#253
  def segment_complete; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#328
  ...
  class << self
    ...
    # environments.
    #
    # source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#376
...
# source://newrelic_rpm//lib/new_relic/agent/transaction/abstract_segment.rb#142
...
# source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#11
class NewRelic::Agent::Transaction::DistributedTracer
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#51
  def initialize(transaction); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#26
  def accept_incoming_request(request, transport_type = T.unsafe(nil)); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#43
  def accept_incoming_transport_type(request, transport_type); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#39
  def accept_transport_type_from_api(value); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#59
  def append_payload(payload); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#88
  def assign_intrinsics; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#35
  def caller_transport_type; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#80
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#72
  def insert_headers(headers); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#67
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#16
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#55
  def record_metrics; end

  # Returns the value of attribute transaction.
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#15
  def transaction; end

  private

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#126
  def consume_message_distributed_tracing_headers(headers, transport_type); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#108
  def consume_message_synthetics_headers(headers); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/distributed_tracer.rb#104
  def dt_enabled?; end
end
...
class NewRelic::Agent::Transaction::ExternalRequestSegment < ::NewRelic::Agent::Transaction::Segment
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#54
  def add_request_headers(request); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#41
  def host; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#37
  def name; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#72
  def process_response_headers(response); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#67
  def record_metrics; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#104
  def add_unscoped_metrics; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#88
  def insert_synthetics_header(request, header, info); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#98
  def process_host_header(request); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#122
  def record_span_event; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#93
  def segment_complete; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#79
  def set_http_status_code(response); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#110
  def suffixed_rollup_metric; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/external_request_segment.rb#118
...
# source://newrelic_rpm//lib/new_relic/agent/transaction/message_broker_segment.rb#10
class NewRelic::Agent::Transaction::MessageBrokerSegment < ::NewRelic::Agent::Transaction::Segment
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/message_broker_segment.rb#56
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/message_broker_segment.rb#50
  def action; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/message_broker_segment.rb#73
  def name; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/message_broker_segment.rb#88
  def transaction_assigned; end
end
...
class NewRelic::Agent::Transaction::RequestAttributes
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#143
  def allow_other_headers?; end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#137
  def attribute_from_env(request, key); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#119
  def attribute_from_request(request, attribute_method); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#107
  def content_length_from_request(request); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#125
  def content_type_attribute_from_request(request); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#159
  def formatted_header(raw_name); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#147
  ...
  # being defensive.
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#101
  def path_from_request(request); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#113
  def port_from_request(request); end

  # Make a safe attempt to get the referer from a request object, generally successful when
  # it's a Rack request.
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/request_attributes.rb#87
...
module NewRelic::Agent::Transaction::TraceContext
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/trace_context.rb#155
  def determine_sampling_decision(payload, trace_flags); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/trace_context.rb#208
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/trace_context.rb#192
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction/trace_context.rb#219
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/trace_context.rb#177
...
module NewRelic::Agent::TransactionErrorPrimitive
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction_error_primitive.rb#41
  def create(noticed_error, payload, span_id); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction_error_primitive.rb#49
...
# source://newrelic_rpm//lib/new_relic/agent/transaction_error_primitive.rb#39
...
module NewRelic::Agent::TransactionEventPrimitive
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction_event_primitive.rb#103
  def agent_attributes(attributes); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction_event_primitive.rb#66
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction_event_primitive.rb#94
  def custom_attributes(attributes); end

  # source://newrelic_rpm//lib/new_relic/agent/transaction_event_primitive.rb#88
...
class NewRelic::Agent::TransactionSqlData
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#191
  def initialize; end

  # Returns the value of attribute guid.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#189
  def guid; end

  # Returns the value of attribute path.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#186
  def path; end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#195
  def set_transaction_info(uri, guid); end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#200
  def set_transaction_name(name); end

  # Returns the value of attribute sql_data.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#188
  def sql_data; end

  # Returns the value of attribute uri.
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#187
  def uri; end
end
...
module NewRelic::Agent::TransactionTimeAggregator
  ...
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/transaction_time_aggregator.rb#77
    def harvest!(timestamp = T.unsafe(nil)); end
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#113
...
# source://newrelic_rpm//lib/new_relic/agent/utilization/ecs.rb#10
class NewRelic::Agent::Utilization::ECS < ::NewRelic::Agent::Utilization::Vendor
  # source://newrelic_rpm//lib/new_relic/agent/utilization/ecs.rb#16
  def transform_key(key); end
end

# source://newrelic_rpm//lib/new_relic/agent/utilization/ecs_v4.rb#10
class NewRelic::Agent::Utilization::ECSV4 < ::NewRelic::Agent::Utilization::Vendor
  # source://newrelic_rpm//lib/new_relic/agent/utilization/ecs_v4.rb#16
  def transform_key(key); end
end
...
class NewRelic::Agent::UtilizationData
  ...
  # not be sent up
  #
  # source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#58
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#65
  def configured_total_ram_mib; end

  # source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#36
  ...
  # source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#24
  def hostname; end

  # source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#32
  def ip_addresses; end

  # source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#45
  def ram_in_mib; end

  # source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#70
  def to_collector_hash; end
end
...
# source://newrelic_rpm//lib/new_relic/agent/utilization_data.rb#17
...
# @api public
#
# source://newrelic_rpm//lib/new_relic/agent.rb#120
...
# source://newrelic_rpm//lib/new_relic/constants.rb#25
...
module NewRelic::Control::InstanceMethods
  ...
  #
  # source://newrelic_rpm//lib/new_relic/control/instance_methods.rb#126
  def [](key); end
  ...
  # each subclass
  #
  # source://newrelic_rpm//lib/new_relic/control/instance_methods.rb#140
  def newrelic_root; end
  ...
  # source://newrelic_rpm//lib/new_relic/control/instance_methods.rb#155
  def root; end
...
module NewRelic::Control::PrivateInstanceMethods
  ...
  # source://newrelic_rpm//lib/new_relic/control/private_instance_methods.rb#45
...
class NewRelic::Control::SecurityInterface
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#19
  def agent_started?; end

  # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#27
  def init_agent; end

  # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#48
  def record_supportability_metrics; end

  # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#52
  def security_agent_metric(setting); end

  # Returns the value of attribute wait.
  #
  # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#12
  def wait; end

  # Sets the attribute wait
  #
  # @param value the value to set the attribute wait to.
  #
  # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#12
  def wait=(_arg0); end
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#23
  def waiting?; end

  class << self
    private

    # source://newrelic_rpm//lib/new_relic/control/security_interface.rb#10
    def allocate; end
...
# source://newrelic_rpm//lib/new_relic/control/security_interface.rb#17
NewRelic::Control::SecurityInterface::DISABLED = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/control/security_interface.rb#16
NewRelic::Control::SecurityInterface::ENABLED = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/control/security_interface.rb#14
NewRelic::Control::SecurityInterface::SUPPORTABILITY_PREFIX_SECURITY = T.let(T.unsafe(nil), String)

# source://newrelic_rpm//lib/new_relic/control/security_interface.rb#15
...
module NewRelic::Control::ServerMethods
  ...
  # source://newrelic_rpm//lib/new_relic/control/server_methods.rb#18
...
module NewRelic::Helper
  ...
  # source://newrelic_rpm//lib/new_relic/helper.rb#93
  ...
  # @api private
  #
  # source://newrelic_rpm//lib/new_relic/helper.rb#117
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/helper.rb#108
  def version_equals?(left, right); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/helper.rb#100
  def version_greater_than?(left, right); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/helper.rb#104
  def version_less_than?(left, right); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/helper.rb#86
...
module NewRelic::LanguageSupport
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/language_support.rb#59
  def bundled_gem?(gem_name); end

  # source://newrelic_rpm//lib/new_relic/language_support.rb#45
  def camelize(string); end

  # source://newrelic_rpm//lib/new_relic/language_support.rb#50
  ...
  # source://newrelic_rpm//lib/new_relic/language_support.rb#38
...
class NewRelic::LocalEnvironment
  ...
  # source://newrelic_rpm//lib/new_relic/local_environment.rb#212
  def executable; end
  ...
  # source://newrelic_rpm//lib/new_relic/local_environment.rb#148
  def check_for_delayed_job; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#144
  def check_for_falcon; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#117
  def check_for_fastcgi; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#92
  def check_for_glassfish; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#187
  def check_for_litespeed; end

  # this case covers starting by mongrel_rails
  #
  # source://newrelic_rpm//lib/new_relic/local_environment.rb#124
  def check_for_mongrel; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#193
  def check_for_passenger; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#138
  def check_for_puma; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#154
  def check_for_resque; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#199
  def check_for_serverless; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#167
  def check_for_sidekiq; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#173
  def check_for_thin; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#85
  def check_for_torquebox; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#101
  def check_for_trinidad; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#130
  def check_for_unicorn; end

  # source://newrelic_rpm//lib/new_relic/local_environment.rb#111
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/local_environment.rb#107
  def jruby_rack?; end
end
...
# source://newrelic_rpm//lib/new_relic/constants.rb#24
...
# source://newrelic_rpm//lib/new_relic/constants.rb#45
...
# source://newrelic_rpm//lib/new_relic/constants.rb#44
...
module NewRelic::SupportabilityHelper
  # source://newrelic_rpm//lib/new_relic/supportability_helper.rb#63
  def record_api_supportability_metric(method_name); end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/supportability_helper.rb#72
...
# source://newrelic_rpm//lib/new_relic/thread_local_storage.rb#6
module NewRelic::ThreadLocalStorage
  class << self
    # source://newrelic_rpm//lib/new_relic/thread_local_storage.rb#23
    def [](key); end

    # source://newrelic_rpm//lib/new_relic/thread_local_storage.rb#27
    def []=(key, value); end

    # source://newrelic_rpm//lib/new_relic/thread_local_storage.rb#7
    def get(thread, key); end

    # source://newrelic_rpm//lib/new_relic/thread_local_storage.rb#15

...
module BinData
  ...
  class << self
    # @yield [@tracer]
    #
    # source://bindata//lib/bindata/trace.rb#45
    def trace_message; end
...
module BinData::AcceptedParametersPlugin
  ...
  #
  # source://bindata//lib/bindata/params.rb#28
  ...
  #
  # source://bindata//lib/bindata/params.rb#26
  ...
  #
  # source://bindata//lib/bindata/params.rb#27
...
class BinData::Array < ::BinData::Base
  ...
  # source://bindata//lib/bindata/array.rb#110
  def <<(*args); end
  ...
  # source://bindata//lib/bindata/array.rb#97
  def index(obj); end
  ...
  # source://bindata//lib/bindata/array.rb#208
  def size; end

  # Returns the element at +index+.
  #
  # source://bindata//lib/bindata/array.rb#151
...
class BinData::Base
  ...
  # source://bindata//lib/bindata/base.rb#232
  ...
  #
  # source://bindata//lib/bindata/warnings.rb#11
...
class BinData::Choice < ::BinData::Base
  ...
  # source://bindata//lib/bindata/choice.rb#98
  def assign(*args); end
...
class BinData::DoubleBe < ::BinData::BasePrimitive
  # source://bindata//lib/bindata/float.rb#22
  def do_num_bytes; end
...
class BinData::IO::Write
  ...
  #
  # source://bindata//lib/bindata/io.rb#258
  def flush; end
...
class BinData::Int8 < ::BinData::BasePrimitive
  # source://bindata//lib/bindata/int.rb#29
  def assign(val); end
...
class BinData::SanitizedParameters < ::Hash
  ...
  # source://bindata//lib/bindata/sanitize.rb#204
...
class BinData::Struct < ::BinData::Base
  ...
  # @return [Boolean]
  #
  # source://bindata//lib/bindata/warnings.rb#34
  def has_key?(key); end

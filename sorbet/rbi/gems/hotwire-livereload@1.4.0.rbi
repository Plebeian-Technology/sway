...
module Hotwire::Livereload
  class << self
    # source://hotwire-livereload//lib/hotwire/livereload/engine.rb#112
    def action_cable(opts); end

    # source://hotwire-livereload//lib/hotwire/livereload/engine.rb#123
    ...
    # @return [Boolean]
    #
    # source://hotwire-livereload//lib/hotwire/livereload/engine.rb#116

...
class Sass::CanonicalizeContext
  ...
  # @return [Boolean]
  #
  # source://sass-embedded//lib/sass/canonicalize_context.rb#13
  def from_import; end
end
...
class Sass::Compiler::Connection
  ...
  # source://sass-embedded//lib/sass/compiler/connection.rb#65
  def close; end

  # @return [Boolean]
  #
  # source://sass-embedded//lib/sass/compiler/connection.rb#74
  def closed?; end

  # source://sass-embedded//lib/sass/compiler/connection.rb#80
...
class Sass::Compiler::Dispatcher
  ...
  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#44
  def close; end

  # @return [Boolean]
  #
  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#52
  def closed?; end

  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#56
  def error(error); end

  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#71
  def receive_proto(id, proto); end

  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#90
  def send_proto(*_arg0, **_arg1, &_arg2); end

  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#17
  def subscribe(observer); end

  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#28
  def unsubscribe(id); end

  private

  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#96
  def _close; end

  # @return [Boolean]
  #
  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#100
  def _closed?; end

  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#104
  def _idle; end

  # @return [Boolean]
  #
  # source://sass-embedded//lib/sass/compiler/dispatcher.rb#108
  def _idle?; end
end
...
class Sass::Compiler::Host::ImporterRegistry
  ...
  # source://sass-embedded//lib/sass/compiler/host/importer_registry.rb#104
  def file_import(file_import_request); end

  # source://sass-embedded//lib/sass/compiler/host/importer_registry.rb#85
  ...
  # source://sass-embedded//lib/sass/compiler/host/importer_registry.rb#120
...
class Sass::Compiler::Host::LoggerRegistry
  ...
  # source://sass-embedded//lib/sass/compiler/host/logger_registry.rb#30
  def log(event); end
  ...
  # source://sass-embedded//lib/sass/compiler/host/logger_registry.rb#47
  def warn(event); end
end
...
class Sass::Value::Function
  ...
  # @return [Function]
  #
  # source://sass-embedded//lib/sass/value/function.rb#46
  ...
  # @return [Integer]
  #
  # source://sass-embedded//lib/sass/value/function.rb#41
  def hash; end
...
class Sass::Value::Mixin
  ...
  # @return [::Boolean]
  #
  # source://sass-embedded//lib/sass/value/mixin.rb#21
  def ==(other); end

  # @return [Mixin]
  #
  # source://sass-embedded//lib/sass/value/mixin.rb#31
  def assert_mixin(_name = T.unsafe(nil)); end

  # @return [Integer]
  #
  # source://sass-embedded//lib/sass/value/mixin.rb#26
  def hash; end

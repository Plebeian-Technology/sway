...
# This is an autogenerated file for types exported from the `state_machines-activerecord` gem.
# Please instead update this file by running `bin/tapioca gem state_machines-activerecord`.


# source://state_machines-activerecord//lib/state_machines/integrations/active_record/version.rb#3
module StateMachines; end

# source://state_machines-activerecord//lib/state_machines/integrations/active_record/version.rb#4
...
#           park: 'estacionarse'
#
# source://state_machines-activerecord//lib/state_machines/integrations/active_record/version.rb#5
module StateMachines::Integrations::ActiveRecord
  ...
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#430
  def around_save(object, &_arg1); end

  # Creates a scope for finding records *with* a particular state or
  # states for the attribute
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#437
  def create_with_scope(name); end

  # Creates a scope for finding records *without* a particular state or
  # states for the attribute
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#450
  def create_without_scope(name); end

  # Uses around callbacks to run state events if using the :save hook
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#408
  def define_action_hook; end

  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#393
  def define_state_initializer; end

  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#473
  def locale_path; end

  # Gets the db default for the machine's attribute
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#387
  ...
  # @return [Boolean]
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#382
  ...
  # (i.e. returns false).
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#465
  ...
  # @return [Boolean]
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#489
  ...
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#481
  ...
  class << self
    ...
    #
    # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#374
    def matching_ancestors; end
  end
end

# source://state_machines-activerecord//lib/state_machines/integrations/active_record/version.rb#6
StateMachines::Integrations::ActiveRecord::VERSION = T.let(T.unsafe(nil), String)

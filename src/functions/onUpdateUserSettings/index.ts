...
import { WEB_PUSH_NOTIFICATION_TOPICS, NOTIFICATION_TYPE } from "src/constants";
    ...
    .onUpdate(
        async (
            ...
            const subscribeEmail =
                ...
                after.notificationType === NOTIFICATION_TYPE.Email;

            const unsubscribeEmail =
                before.notificationType === NOTIFICATION_TYPE.Email &&
                after.notificationType === null;

    ...
    return (
        <>
            ...
            <Route
                ...
                element={<BillOfTheWeek user={user} />}
            />
            <Route path={"bills"} element={<BillsList user={user} />}>
                <Route path={"bill"}>
                    <Route path={":localeName"}>
                        <Route
                            path={":billFirestoreId"}
                            element={<BillRoute user={user} />}
                        />
                    </Route>
                </Route>
            </Route>

            <Route path={"influence"} element={<UserInfluence user={user} />} />

...
ActiveRecord::Schema[8.0].define(version: 20_250_909_195_550) do
    create_table "addresses", force: :cascade do |t|
        ...
        t.index %w[latitude longitude], name: "index_addresses_on_latitude_and_longitude"
    end
    ...
    create_table "bills", force: :cascade do |t|
        ...
        t.index %w[external_id sway_locale_id], name: "index_bills_on_external_id_and_sway_locale_id", unique: true
        t.index ["legislator_id"], name: "index_bills_on_legislator_id"
        t.index %w[scheduled_release_date_utc sway_locale_id],
                        name: "index_bills_on_scheduled_release_date_utc_and_sway_locale_id",
                        unique: true
    ...
    create_table "districts", force: :cascade do |t|
        ...
        t.datetime "created_at", null: false
        t.datetime "updated_at", null: false
        t.index %w[name sway_locale_id], name: "index_districts_on_name_and_sway_locale_id", unique: true
    ...
    create_table "organization_bill_positions", force: :cascade do |t|
        ...
        t.datetime "created_at", null: false
        t.datetime "updated_at", null: false
        t.index %w[bill_id organization_id], name: "idx_on_bill_id_organization_id_f380340a40", unique: true
    ...
    create_table "organizations", force: :cascade do |t|
        ...
        t.datetime "created_at", null: false
        t.datetime "updated_at", null: false
        t.index %w[name sway_locale_id], name: "index_organizations_on_name_and_sway_locale_id", unique: true
    ...
    create_table "sway_locales", force: :cascade do |t|
        ...
        t.index %w[city state country], name: "index_sway_locales_on_city_and_state_and_country", unique: true
    end
    ...
    create_table "user_legislators", force: :cascade do |t|
        ...
        t.index %w[user_id legislator_id], name: "by_unique_user_and_legislator", unique: true
    ...
    create_table "user_organization_memberships", force: :cascade do |t|
        ...
        t.index %w[user_id organization_id], name: "idx_on_user_id_organization_id_7cc0c85071", unique: true
